...
.. glossary::
   ...
   Channel
      A system entity, the instances of which represent a source of customers and customer data.   
    
   Entity
      A grouping of things with common rules and/or data applied to all of its instances.
