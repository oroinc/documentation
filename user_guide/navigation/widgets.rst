...
You can add widgets in any combination and move them around the page creating a dashboard that displays content in a way most convenient to you (see :ref:`Add Widgets <widgets-add>`). Many widgets are customizable: you can set a custom name for them, apply filters to the data that widgets display and so on.
