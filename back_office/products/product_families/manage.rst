...
.. image:: /img/products/product_families/ProductFamiliesView.png
...
1. In the **Attributes** section, click **+ Add** to create a new group.
   ...
   .. image:: /img/products/product_families/ProductAttributeAddGroup.png
...
2. Once you are done with the product attribute organization, click **Save**.
   ...
   .. image:: /img/products/product_families/ProductAttributeAddToGroup.png
...
1. When an attribute you are adding to the group is already a member of another attribute group in this product family, the *move from \<attribute group\>* will be shown next to the attribute name in the hint list that appears as you type.
   ...
   .. image:: /img/products/product_families/ProductAttributeFamiliesMove.png
...
1. Click **x** on the top right of the group area.
   ...
   .. image:: /img/products/product_families/ProductAttributeRemoveGroup.png
