...
.. image:: /img/system/workflows/alternative_checkout/ACF_page.png

.. image:: /img/system/workflows/alternative_checkout/ACF_configuration.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_grid.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_table.png
   :align: center
...
.. include:: /back_office/system/workflows/system_workflows/checkout.rst
   :start-after: start_checkout_sample_0
   :end-before: finish_checkout_sample_0

.. |create_order_img| image:: /img/system/workflows/alternative_checkout/ACF_CreateOrderButton.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_CreateBilling.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_CreateShipping.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_ShippingMethod.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_Payment.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_OrderReview.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_RequestApproval.png

Order Approval will remain pending until the manager approves it.

.. image:: /img/system/workflows/alternative_checkout/ACF_ApprovalPending.png
...
.. image:: /img/system/workflows/alternative_checkout/ACF_ApproveOrder.png

At this point, the manager can submit the order themselves, or let the employee handle the order:

.. image:: /img/system/workflows/alternative_checkout/ACF_Approved.png
