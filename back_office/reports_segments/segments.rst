...
.. image:: /img/reports/use_segments_in_filter.png
...
#. In the *General Details*:
   ...
   .. image:: /img/reports/segment_general.png
...
#. In the *Designer > Columns* section, define the set of the fields of the entity records to be shown in the segment.
   ...
   .. image:: /img/reports/list_columns.png
   ...
   In order to add a column to the grid:
      ...
      .. image:: /img/reports/segments_column.png
...
.. image:: /img/reports/segment_view.png
