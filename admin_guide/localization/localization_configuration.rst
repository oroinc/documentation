...
The system configuration of the localization settings is available on three levels: globally, per organization, and per user. The configuration steps are provided below:
...
2. In the **Location Options** section, provide:
