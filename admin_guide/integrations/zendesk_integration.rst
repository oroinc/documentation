...
1. Open your account and go to the **Admin** page.
   ...
   .. image:: /admin_guide/img/zendesk/zendesk_admin.png
...
4. Copy an active API token.
   ...
   .. image:: /admin_guide/img/zendesk/zendesk_api_token.png
...
.. image:: /admin_guide/img/zendesk/zendesk_create.png
...
.. note:: To delete or edit integration details, navigate to the the page with all integrations **System > Integrations > Manage Integrations**.
    ...
    .. image:: /admin_guide/img/zendesk/zendesk_edit.png
...
.. image:: /admin_guide/img/zendesk/example_ticket.png
