...
`ChannelBundle`_ (OroCRM)
    ...
    .. seealso::
        ...
        * User guide: :doc:`/user_guide_sales_tools/customer_management/common_features_multi_channel_functionality`
        * User guide: :doc:`/user_guide_sales_tools/customer_management/common_features_channels`
        * User guide: :doc:`/user_guide_sales_tools/customer_management/common_features_accounts`
        * User guide: :doc:`/user_guide_sales_tools/b2b_sales/sales_channels`
...
`CronBundle`_ (OroPlatform)
    ...
    .. seealso::
        ...
        * Book: :doc:`/admin_guide/monitoring/jobs`
...
`DemoDataBundle`_ (OroCRM)
    ...
    .. seealso::
        ...
        * Book: :ref:`Installation <installation>`
...
`EntityConfigBundle`_ (OroPlatform)
    ...
    .. seealso::
        ...
        * Book: :doc:`/dev_guide/data/data_audits`
        * Book: :doc:`/dev_guide/getting_started_book/configuration`
        * Book: :doc:`/dev_guide/entities/index`
...
`ReportBundle`_ (OroPlatform and OroCRM)
    ...
    .. seealso::
        ...
        * User guide: :doc:`/user_guide_sales_tools/b2b_sales/opportunities`
        * User guide: :doc:`/user_guide_business_intelligence/reports`
...
`SalesBundle`_ (OroCRM)
    ...
    .. seealso::
        ...
        * User guide: :doc:`/user_guide_sales_tools/b2b_sales/sales_processes_workflow`
...
`SecurityBundle`_ (OroPlatform)
    ...
    .. seealso::
        ...
        * Book: :doc:`/admin_guide/security/index`
