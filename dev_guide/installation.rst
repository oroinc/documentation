...
.. warning:: The newer version of the topic is available in versions `2.3 <https://oroinc.com/orocrm/doc/2.3/install-upgrade>`_, `2.6 <https://oroinc.com/orocrm/doc/2.6/install-upgrade>`_, and `current <https://oroinc.com/orocrm/doc/current/install-upgrade>`_.

This article describes how to install the OroPlatform application or the OroCRM application. Both
applications are similar, but the platform contains only a subset of all :ref:`bundles <bundles>` available in the
full CRM.
