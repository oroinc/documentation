...
.. _`usage of ACLs`: http://symfony.com/doc/current/dev_guide/cookbook/security/acl.html
.. _`complex Access Control List`: http://symfony.com/doc/current/dev_guide/cookbook/security/acl_advanced.html
