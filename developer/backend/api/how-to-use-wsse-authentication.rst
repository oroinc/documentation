...
It's based on the |EscapeWSSEAuthenticationBundle| that covers most cases from the WSSE |specs|.
...
.. image:: /developer/img/backend/api/user_api_key_generation.png
