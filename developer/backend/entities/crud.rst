...
As you can see, the template extends the |OroUIBundle:actions:index.html.twig| template from the
OroPlatform and uses a |macro from the UI bundle| to add a button for creating new vehicles.
...
The template extends the |update.html.twig| base template that is defined in the OroUIBundle. You
