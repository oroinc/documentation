...
System Configuration ``system_configuration.yml``
=================================================
...
The following example shows a complete working configuration taken from the |system_configuration.yml file|
...
The name of a |Font Awesome Icon| (prefixed with the string ``icon-``) that will be displayed next
to the group name.
