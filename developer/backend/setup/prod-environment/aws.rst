...
Deploying on the AWS Cloud Platform
===================================
...
3. Click **Launch Instance**.
   ...
   .. image:: /developer/img/backend/setup/aws/EC2_dashboardh.png
...
Now you have to choose the source for the Amazon Machine Image that will be run on the EC2 instance.
   ...
   .. image:: /developer/img/backend/setup/aws/choose_an_ami.png

5. In the **Search AWS Marketplace Products** field, type in *Oro* and press **Enter**.

   .. image:: /developer/img/backend/setup/aws/aws_marketplace.png
...
6. Select the required AMI from the list and click **Select** (e.g. OroCommerce Community Edition with Demo Data).
   ...
   .. image:: /developer/img/backend/setup/aws/oro_amis.png
...
7. Click **Continue**.
   ...
   .. image:: /developer/img/backend/setup/aws/ami_desrciption.png

You are then redirected to the next step of the installation.

   .. image:: /developer/img/backend/setup/aws/select_ec2_instance_type.png
...
the reasonable preconfigured default values. Should you need to change the default values, return to Steps 3 to 6.
   ...
   .. image:: /developer/img/backend/setup/aws/step_7.png
...
a new key pair.
   ...
   .. image:: /developer/img/backend/setup/aws/select_a_key_pair.png
...
management page and other helpful resources.
   ...
   .. image:: /developer/img/backend/setup/aws/launch_status.png
...
Below the launched instances list shown the detailed information about the selected instance.
   ...
   .. image:: /developer/img/backend/setup/aws/launching_instance.png
