...
* `Fundamentals <https://github.com/oroinc/platform/tree/master/src/Oro/Bundle/ActivityListBundle#fundamentals>`__
* `Add Widget to a Page <https://github.com/oroinc/platform/tree/master/src/Oro/Bundle/ActivityListBundle#add-widget-into-a-page>`__
* `Show Widget and Its Button on a Specific page <https://github.com/oroinc/platform/tree/master/src/Oro/Bundle/ActivityListBundle#show-widget-and-its-button-on-specific-page-viewedit>`__
* `Register a New Entity <https://github.com/oroinc/platform/tree/master/src/Oro/Bundle/ActivityListBundle#add-widget-into-a-page>`__
