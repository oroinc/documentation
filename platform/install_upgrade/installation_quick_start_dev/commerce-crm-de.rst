...
.. code:: bash
   ...
   git clone -b 3.0 https://github.com/orocommerce/orocommerce-application-de.git oroapp
   cd oroapp

..
   The *branch* value (*3.0* in this example) could be changed to any published
   `release tag <https://github.com/oroinc/orocommerce-application-de/releases>`_ from 3.0 branch of
