...
Application Framework funcionality in OroPlatform is based on the `Symfony Framework <https://symfony.com/>`_ and extends it in the
`OroPlatformBundle`_ and `OroDistributionBundle`_ to improve several aspects of development experience.
...
`Create and Publish an Extension`_ to the `Oro marketplace <https://platform-marketplace.orocrm.com/>`_.
...
Please see the :ref:`Create Custom Oro Application <dev-cookbook-create-custom-oro-application>` cookbok article.
...
.. _`@Acl`: https://github.com/oroinc/platform/blob/master/src/Oro/Bundle/SecurityBundle/Annotation/Acl.php
.. _`@AclAncestor`: https://github.com/oroinc/platform/blob/master/src/Oro/Bundle/SecurityBundle/Annotation/AclAncestor.php
.. _`Composer`: https://getcomposer.org/
.. _`OroPlatformBundle`: https://github.com/oroinc/platform/tree/master/src/Oro/Bundle/PlatformBundle
.. _`OroDistributionBundle`: https://github.com/oroinc/platform/tree/master/src/Oro/Bundle/DistributionBundle
.. _`Packagist`: https://packagist.org/
.. _`Oro Marketplace`: https://platform-marketplace.orocrm.com/

.. Future Subsections of this guide:
    Symfony (Application, Application Structure, Bundle, Bundle Structure, Entity, Controller, Templates, DI container, Extensions)
    +PlatformBundle (auto-dicsovery of configuration files and maintenance mode, lazy services, disable listeners, global options for all commands)
    +DistributionBundle (bundles auto-registration, routing auto-registration, package management)
    ConfigBundle
    InstallerBundle
    FeatureToggleBundle
