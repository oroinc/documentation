...
.. csv-table::
   :header: "**Quantity Tier**","**Customer A PL (merge: yes)**","**Spring Sale PL (merge: no)**","**Resulting Price**"
...
.. csv-table::
   :header: "**Quantity Tier**","**Customer A PL (merge: no)**","**Spring Sale PL (merge: yes)**","**Resulting Price**"
...
* :ref:`Price Lists User Guide <user-guide--pricing--pricelist--management>` --- aggregates practical information on how to work with price lists and adapt them to your business needs:
   ...
   * :ref:`Tier Pricing in the Storefront <frontstore-guide--navigation-product-price>`
