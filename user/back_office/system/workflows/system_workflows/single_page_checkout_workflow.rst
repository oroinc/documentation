...
* Activate the workflow: |IcActivate|
   ...
   .. image:: /user/img/system/workflows/single_page_checkout/SPCActions.png
...
* Activate --- Click |IcActivate| **Activate** on the top right of the page to activate the workflow.
  ...
  .. image:: /user/img/system/workflows/single_page_checkout/SPCActivate.png
...
* Deactivate (if the workflow is active) -- click |IcDeactivate| **Deactivate** on the top right of the page to deactivate the workflow.
  ...
  .. image:: /user/img/system/workflows/single_page_checkout/SPCDeactivate.png
...
.. image:: /user/img/system/workflows/single_page_checkout/SPCStepsTransitions.png
...
7. The customer receives an email confirmation with order details.
   ...
   .. image:: /user/img/system/workflows/single_page_checkout/SampleFlow4.png
