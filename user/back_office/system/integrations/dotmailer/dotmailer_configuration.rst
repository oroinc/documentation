...
5. Click the **New User** button.
   ...
   .. image:: /user/img/system/integrations/dotmailer/dotmailer_account_users.jpg
...
6. Next, create and confirm your **Password**. The **Description** field is optional. Mark your user **Enabled** and click **Save** to proceed.
   ...
   .. image:: /user/img/system/integrations/dotmailer/dotmailer_api_users_new_user_details.jpg
...
2. Click **Create Integration** in the upper-right corner of the page.
   ...
   .. image:: /user/img/system/integrations/dotmailer/oro_create_dotmailer_integration_new.jpg
...
.. image:: /user/img/system/integrations/dotmailer/oro_dotmailer_integration_grid.jpg
...
.. image:: /user/img/system/integrations/dotmailer/o_dotmailer_main_menu.jpg
