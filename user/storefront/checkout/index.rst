:title: Checkout with the OroCommerce 4.1 Storefront

.. meta::
   :description: Instructions on multi page, single page, and guest checkouts within the OroCommerce 4.1 storefront
