...
.. hint:: The Saved Search feature is available since OroCommerce v4.2.4. To find out which application version you are running, ask your system administrator to check the :ref:`system information <system-information>`.
