:title: Quotes Management in the OroCommerce 4.1 Storefront

.. meta::
   :description: Quotes creation and management guides for the OroCommerce 4.1 storefront users
...
After you submit a quote, it becomes available in the :ref:`Quotes <my-account-quotes>` menu which you can reach via the :ref:`Quick Access Menu <frontstore-guide--navigation-quick-access-menu>` under **Quotes**.
