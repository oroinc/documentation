...
* **Include in Smart Insights** --- If set to *yes*, this field will be considered in :ref:`OroIQ Smart Insights <concept-guide--oroiq>` to generate analytics, trends, and contextual recommendations (available as of OroCommerce version 7.0.2).
