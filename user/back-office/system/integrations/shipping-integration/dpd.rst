...
.. hint::
        The feature requires extension, so visit Oro Extensions Store to download the |DPD extension| and then use the composer to :ref:`install the extension to your application <cookbook-extensions-composer>`.
