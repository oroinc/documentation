...
.. hint:: The configuration of Google Tag Manager with Google Analytics 4 is available starting from OroCommerce v5.0.5. To check which application version you are running, see the :ref:`system information <system-information>`.
