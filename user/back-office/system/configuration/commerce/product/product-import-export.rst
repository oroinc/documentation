.. _configuration--guide--commerce--product-import-export:
...
.. note:: You can also configure category options :ref:`per organization <sys--users--organization--commerce--products--import-export>`.
