...
3. In the **Search Term Management** section, clear the *Use Default* check box to enable the search term functionality.
...
4. In the **Search History** section, clear the *Use Default* check box to configure the following search history reporting options:
...
5. In the **Special Pages** section, clear the *Use Default* check box to configure the empty search results page:
