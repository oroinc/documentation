...
.. hint:: The Saved Search feature is available starting from OroCommerce Enterprise v4.2.4. To check which application version you are running, see the :ref:`system information <system-information>`.
