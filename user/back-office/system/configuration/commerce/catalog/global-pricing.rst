...
.. _offset-of-processing-cpl-prices:
   ...
   * **Pricing Strategy** --- The strategy that is used for a price lookup.
     ...
     OroCommerce searches for the closest match of the product price in the selected units and currency for the requested product quantity in one of the following ways:
