...
|                           | the grid, you can open it in a new tab/window. The option is available from v4.2.8; to check which             |
|                           | application version you are running, see the :ref:`system information <system-information>`. The option        |
