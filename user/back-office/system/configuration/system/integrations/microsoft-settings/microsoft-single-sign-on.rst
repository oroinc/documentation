...
.. hint::
    Microsoft 365 Single Sign-On is available starting from OroCRM Enterprise v4.2.7 as part of the |Oro-Microsoft 365 Integration| extension. To check which application version you are running, see the :ref:`system information <system-information>`.
