...
Now, when you use the ``http://localhost/<yoursitename>/index_dev.php`` address, the asset files (styles.css, app.js, etc.) are taken from the root folder on the domain instead of the dedicated website sub-folder.
