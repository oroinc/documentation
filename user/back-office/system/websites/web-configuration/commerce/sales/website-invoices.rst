...
You can configure invoice-related sales :ref:`globally <configuration--guide--commerce--configuration--sales-invoices>`, :ref:`per organization <user-guide--system-configuration--commerce-sales-invoices-org>`, website, :ref:`customer group <user-guide--customer-group---invoice--settings>` and :ref:`customer <user-guide--customers--checkout--settings>`.
