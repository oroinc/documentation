...
This can be configured on three levels -- :ref:`globally <user-guide--system-configuration--commerce-sales-shopping-list--mass-action>`, :ref:`per organization <user-guide--system-configuration--commerce-sales-shopping-list-per-organization>`, and website.

To configure the shopping lists per website:
