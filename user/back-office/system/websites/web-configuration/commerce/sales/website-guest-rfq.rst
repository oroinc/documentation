...
4. In the **Notifications** section, configure the notifications options for:
   ...
   * The Owner Of The Customer
   ...
   To customize any of these options, clear the **Use Organization** check box next to the option and select the corresponding option from the list.
...
5. In the **Guest RFQ** section, set whether guests are allowed to submit a request for quote. Disabled by default.

   To enable it, clear *Use Organization* and select the *Enable Guest RFQ* check box.
