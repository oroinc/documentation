.. _website-commerce--configuration--shipping--address-validation:

Configure Address Validation Settings per Website
=================================================

.. note:: The Address Validation feature can be configured on the :ref:`global <sys--conf--commerce--shipping--address-validation>`, :ref:`organization <organization-commerce--configuration--shipping--address-validation>`, and website levels.
...
3. Select **Commerce > Shipping > Address Validation** in the menu to the left.
   ...
   .. image:: /user/img/system/config_commerce/shipping/address-validation-default-website.png
      :alt: Website-level address validation configuration settings
