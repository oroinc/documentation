...
The SEO-related settings can be configured :ref:`globally <sys--conf--commerce--guest-seo--global>`, :ref:`per organization <sys--conf--commerce--guest-seo--org>`, and per website.
