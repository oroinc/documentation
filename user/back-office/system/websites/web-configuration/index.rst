...
.. important:: Website-level configuration settings can fall back to organization settings. For this, select the **Use Organization** checkbox next to the selected option. To go back to the default website-level settings, click **Reset** at the top right.
...
* **Commerce Configuration**
  ...
  * Sales
    ...
    * :ref:`Recurring Orders <user-guide--system-configuration--commerce-sales-recurring-orders-website>`
