...
1. Navigate to **System > Websites** using the main menu of the :ref:`global organization <user-management-organizations>`.
...
OroCommerce provides sellers with effective payment solutions that help enhance customers' buying experience. Integration with the most popular payment services as :ref:`PayPal <user-guide--payment--payment-providers-overview--paypal>`, :ref:`Authorize.Net <user-guide--payment--payment-providers-overview--authorizenet>`, and :ref:`InfinitePay <user-guide--payment--payment-providers-overview--infinitepay>` into OroCommerce enables various payment transactions to be made in a particular localization and on a certain website.
