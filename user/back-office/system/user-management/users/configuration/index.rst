...
.. important:: User-level configuration settings can fall back to :ref:`organization settings <doc-organization-configuration>`. For this, select the **Use Organization** checkbox next to the selected option. To go back to the default user-level settings, click **Reset** at the top right.
