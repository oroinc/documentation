...
7. In the **File Names** section, you can control whether to use original file names.
   ...
   .. hint:: The **File Names** setting is available starting from v4.2.11. and can be configured :ref:`globally <admin-configuration-upload-settings>`, per organization, and :ref:`per website <upload-settings--website>`.
