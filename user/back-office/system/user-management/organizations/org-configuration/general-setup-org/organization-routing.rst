...
4. Remove the **Use System** to deselect the **Prefer Self-Contained Web Catalog Canonical URLs** option for the organization. When this option is disabled, the canonical URLs point to the direct URLs of the underlying content types if they are available. This option is disabled by default.
