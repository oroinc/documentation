...
.. hint:: The SEO configuration is available since v5.0.3. To check which application version you are running, see the :ref:`system information <system-information>`.
