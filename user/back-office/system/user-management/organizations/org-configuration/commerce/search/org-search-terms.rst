...
4. In the **Search History** section, clear the *Use System* check box to configure the following search history reporting options:
...
5. In the **Special Pages** section, clear the *Use System* check box to configure the empty search results page:
