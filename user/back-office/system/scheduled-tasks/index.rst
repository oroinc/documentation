...
With Oro, you can use the |OroCronBundle|, which runs Symfony Console commands through :ref:`cronjobs <dev-guide-system-cron-jobs>` (on UNIX-based operating systems) or Windows task scheduler.
