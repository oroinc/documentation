...
.. .. image:: /user/img/system/workflows/backoffice_quote_approval_flow/backoffice_quote_with_approval_scheme.png
...
#. Jin opens the approved quote either via the link in the email or by looking it up in the quotes list using the filter by internal status (is any of "Reviewed").
   ...
   .. image:: /user/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_approve3.png
