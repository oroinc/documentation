...
#. Click the **More actions** and then the **Cancel** button at the top right of the page.
...
1. In the main menu, navigate to **Sales > Orders**.
#. Choose the order in the list and click it. The order details page opens.
#. Click the **More actions** and then the **Close** button at the top right of the page.
