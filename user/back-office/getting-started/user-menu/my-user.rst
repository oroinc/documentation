...
.. note:: Next, read the topic on how to :ref:`Add OAuth Applications to OroCommerce Storefront <user-guide--customers--customer-users--oauth>`.

Configure User-Level Settings
-----------------------------

Read the :ref:`My Configuration <doc-my-user-configuration-profile>` topic for the details on how to configure available system settings for a particular user.
