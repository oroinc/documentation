...
#. You have the option to choose to hide the title of the landing page in the storefront when a landing page is accessed directly (not via a web-catalog). For this, enable the **Do not render title** option.
