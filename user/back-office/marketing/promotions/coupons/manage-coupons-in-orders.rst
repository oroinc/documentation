...
4. Under **All Promotions**, to the left of the section, click |IcView| at the end of the coupon code row.

   .. image:: /user/img/marketing/coupons/ViewCouponsIcon.png
      :alt: View the coupon applied to the order in the back-office

5. In the popup that opens, you can view the details of the selected coupon, as illustrated below.

   .. image:: /user/img/marketing/coupons/ViewCoupon.png
      :alt: View the details of the coupon applied to the order in the back-office
