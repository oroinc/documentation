...
3. Complete the following fields:
   ...
   .. csv-table::
      ...
      "**Type**","Select an attribute type to store the value of the specific data type. For the list of available field types and their purposes, refer to the :ref:`relevant section <field-file-types>` of the Entity Field Properties topic.
