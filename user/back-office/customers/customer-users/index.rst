...
#. Select a parent customer if you are adding a subsidiary of the existing customer.
...
You may want to delegate some of the customer user management capabilities to the customer users with an administrator role by enabling *Account Management* permissions and capabilities. See the :ref:`Customer User Roles <user-guide--customers--customer-user-roles>` section for more information about permissions and capability management.
