...
3. Provide the following information:
   ...
   * **Account** --- An :ref:`account <user-guide-accounts-create>` to which the customer will be assigned. Details of this business customer will then be part of this account's details.
...
.. The other available actions depend on the system settings defined in the  **Communication &  Collaboration** section of the **Business Customer** entity configuration. See step 4 of the :ref:`Create an Entity <doc-entity-actions-create>` action description.
