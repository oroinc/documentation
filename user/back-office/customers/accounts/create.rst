...
3. Provide the following information:
   ...
   * **Owner** --- Limits the list of users that can manage the account to users whose :ref:`roles <user-guide-user-management-permissions>` allow managing accounts assigned to the owner (e.g., the owner, members of the same business unit, a system administrator, etc.). By default, the user creating the account is selected as the owner.
