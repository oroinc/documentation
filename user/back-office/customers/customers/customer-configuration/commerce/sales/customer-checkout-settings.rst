...
.. image:: /user/img/customers/customers/configuration/customer-order-limits-settings.png
   :alt: Checkout order limits customer configuration settings

3. Select **Commerce > Sales > Checkout** in the menu to the left.
4. In the Checkout section, clear the **Use Customer Group** checkbox and configure the following options:
