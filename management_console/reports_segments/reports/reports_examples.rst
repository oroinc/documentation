...
.. image:: /img/reports/reports_examples_1.png
...
3. You are now redirected to the report view that shows the opportunities with the known **Budget Amount**:
   ...
   .. image:: /img/reports/reports_examples_2.png
      :width: 60%
...
5. Click |IcEdit| to update the column and change the function for the **Budget amount** to *Count*.
   ...
   .. image:: /img/reports/reports_examples_3.png

6. Click **Save**. The report data changes:

   **Report Preview (Function = Count)**

   .. image:: /img/reports/reports_examples_4.png
      :width: 60%
...
.. image:: /img/reports/reports_examples_7.png

The report preview:

.. image:: /img/reports/reports_examples_8.png
...
.. image:: /img/reports/reports_examples_9.png
...
.. image:: /img/reports/reports_examples_10.png
...
.. hint::
    ...
    .. image:: /img/reports/reports_examples_11.png
...
.. image:: /img/reports/reports_examples_12.png

Output:

.. image:: /img/reports/reports_examples_13.png
