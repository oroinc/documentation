...
.. image:: /img/products/products/Products.png
   :alt: The all products page
...
* To display/hide tier prices, in the left panel, select/clear the **Show Tier Prices** check box.
   ...
   .. image:: /img/products/products/ProductsFilterPrices.png
...
* To display/hide product from the sub-categories, in the left panel, select/clear the **Include Sub-Categories** check box.
    ...
    .. image:: /img/products/products/ProductsCategories.png
...
.. image:: /img/products/products/ProductGridActions.png
