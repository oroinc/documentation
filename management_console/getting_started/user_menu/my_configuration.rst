...
.. image:: /img/getting_started/user_menu/my_user_config_localization.png
...
|                    |                                                                                                                                    |
|                    | .. image:: /img/getting_started/user_menu/user_configuration_showemailsuserbar.png                                                 |
...
|                           |                                                                                                                |
|                           | .. image:: /img/getting_started/user_menu/user_configuration_pagination.png                                    |
...
|                       |                                                                                                           |
|                       | .. image:: /img/getting_started/user_menu/user_configuration_wysiwyg.png                                  |
...
.. image:: /img/getting_started/user_menu/user_configuration_showsql.png
...
|                      |                                                                                                                                                                                                    |
|                      | .. image:: /img/getting_started/user_menu/reply_selector.png                                                                                                                                       |
...
.. image:: /img/getting_started/user_menu/my_user_config_outlook.png
...
| Field                              | Description                                                                                                                              |
+====================================+==========================================================================================================================================+
| Sync Direction                     | Select whether the data will be taken from Oro app to Outlook, from Outlook to Oro app or synchronization will occur in both directions. |
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
| Conflict Resolution                | Select whether Oro app or Outlook has priority if the same piece of data has been changed in both systems.                               |
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
| CRM Sync Interval (In Seconds)     | Type how often changes on Oro application side will be checked.                                                                          |
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
...
.. image:: /img/getting_started/user_menu/sales_rep_info.png
