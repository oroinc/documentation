...
.. image:: /admin_guide/img/configuration/sales/contacts/SalesInfoGlobal.png
...
3. In the **Display** list, select one of the options that will determine what and whose information to show on the website:
   ...
   .. include:: /admin_guide/landing_commerce/sales/sales_info/display_details.rst
...
4. Select **Available User Options**.
   ...
   .. include:: /admin_guide/landing_commerce/sales/sales_info/available_user_options.rst
...
.. image:: /admin_guide/img/configuration/sales/contacts/GuestContact.png
