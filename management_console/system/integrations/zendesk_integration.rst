...
1. Open your account and go to the **Admin** page.
   ...
   .. image:: /img/system/integrations/zendesk/zendesk_admin.png

2. Navigate to the **CHANNELS > API**.

   .. image:: /img/system/integrations/zendesk/zendesk_api.png
      :width: 40%
...
4. Copy an active API token.
   ...
   .. image:: /img/system/integrations/zendesk/zendesk_api_token.png
...
.. image:: /img/system/integrations/zendesk/zendesk_create.png
...
.. note:: To delete or edit integration details, navigate to the the page with all integrations **System > Integrations > Manage Integrations**.
    ...
    .. image:: /img/system/integrations/zendesk/zendesk_edit.png
...
.. image:: /img/system/integrations/zendesk/example_ticket.png
