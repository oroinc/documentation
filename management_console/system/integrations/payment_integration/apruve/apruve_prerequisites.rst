...
1. Contact https://www.apruve.com/ to get started and schedule a time for a conversation with a member of the Apruve Sales Team.
   ...
   .. image:: /img/system/integrations/apruve/apruve_prerequisites_1.png
      :class: with-border
...
3. Log into the https://app.apruve.com with your email address and password generated in the previous step.
   ...
   .. image:: /img/system/integrations/apruve/apruve_prerequisites_2.png
      :class: with-border
...
4. Fill in the following sections under **Get Started Checklist** to enable the credit program for your customer user:
   ...
   * **Connect API** --- Integrate the Apruve API into the OroCommerce checkout.
   ...
   .. image:: /img/system/integrations/apruve/apruve_prerequisites_3.png
      :class: with-border
...
3. Fill in *Store Details* in the **Merchant** section with the following credentials:
   ...
   * Business Tax ID (optional)
   ...
   .. image:: /img/system/integrations/apruve/apruve_prerequisites_4.png
      :class: with-border
...
4. Click **Save Changes** to proceed to the **Branding** section next to **Merchant** section and upload the logo image of your store.
   ...
   .. image:: /img/system/integrations/apruve/apruve_prerequisites_5.png
      :class: with-border
...
.. image:: /img/system/integrations/apruve/apruve_prerequisites_6.png
   :class: with-border
...
3. Click **Create an API Key**.
   ...
   .. image:: /img/system/integrations/apruve/apruve_prerequisites_7.png
      :class: with-border
...
5. Save it by clicking **Create Key**.
   ...
   .. image:: /img/system/integrations/apruve/apruve_prerequisites_8.png
      :class: with-border
...
5. Click **Save Notification Preferences**.
   ...
   .. image:: /img/system/integrations/apruve/apruve_prerequisites_9.png
      :class: with-border
