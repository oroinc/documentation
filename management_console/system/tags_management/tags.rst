...
3. In the **Other** section, select **Yes** in the **Enable Tags** field.
   ...
   .. image:: /img/system/tags_management/enable_tags_4.png
...
3. Specify tags for the entity. You can enter multiple tags for one entity.
   ...
   .. image:: /img/system/tags_management/entity_grid_inline_tag_12.png
...
2. Click |IcPencil| edit in Tags.
   ...
   .. image:: /img/system/tags_management/entity_view_page_14.png
      :alt: Click the edit icon in the Tags field of the selected entity record

3. Specify tags for the entity. You can enter multiple tags for one entity.

   .. image:: /img/system/tags_management/entity_view_page_15.png
      :alt: Specify the tags for the entity in the field that opened

4. Click |IcCheck| to save the tags for the entity.

   .. image:: /img/system/tags_management/entity_view_page_17.png
...
.. image:: /img/system/tags_management/tags_grid_manage_18.png
...
.. image:: /img/system/tags_management/tag_link_20.png
...
.. image:: /img/system/tags_management/content_view_page_21.png
...
.. image:: /img/system/tags_management/report_create_gold_22.png
   :alt: Apply the mentioned conditions in the Filters section

.. image:: /img/system/tags_management/report_created_gold_23.png
