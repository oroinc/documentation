...
2. Click on the website you would like to use as default (e.g. Australia).
   ...
   .. image:: /img/system/websites/view_website_australia.png
...
.. image:: /img/system/websites/default_australia_website.png
...
4. Click on the menu to start customizing it:
   ...
   * Click on the menu item to edit its details.
     ...
     .. image:: /img/system/websites/edit_menu_item.png
...
Customize Web Catalogs per a Website
------------------------------------
...
Customize Price Lists per a Website
-----------------------------------
...
Customize Product Visibility per a Website
------------------------------------------
...
Customize Promotion Visibility per a Website
--------------------------------------------
...
Customize a Payment Method per a Website
----------------------------------------
...
Customize a Shipping Method per a Website
-----------------------------------------
