...
For instance, a contact is a system entity. When you create a new contact record in the application (e.g., a potential customer called Mary Smith), it becomes a contact record in OroCommerce. Information about contact records is organized into a set of properties, such as the first name, the last name, a telephone number, etc. Every entity in Oro applications has its own properties, depending on what this entity is supposed to represent or display.
