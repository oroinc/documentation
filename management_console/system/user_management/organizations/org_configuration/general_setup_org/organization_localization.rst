...
.. image::/img/system/user_management/org_configuration/general/localization_configuration_organization.png
...
5. In the **Map Settings**, select the **Temperature Unit** and **Wind Speed Unit** to display the weather on the map. The default values are Fahrenheit and miles per hour (MPH).
   ...
   .. image::/img/system/user_management/org_configuration/general/localization_map.png
