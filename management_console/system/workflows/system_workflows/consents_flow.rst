...
By default, the Checkout with Consents workflow is disabled in the OroCommerce application, and can be activated for the storefront through the management console.
...
.. |create_order_img| image:: /img/system/workflows/checkout/CreateOrderButton.png
...
.. image:: /img/system/workflows/checkout_with_consents/billing_information_step_checkout_with_consents.png
...
.. image:: /img/system/workflows/checkout_with_consents/shipping_method_checkout_with_consents.png
...
.. image:: /img/system/workflows/checkout_with_consents/payment_method_step_checkout_with_consents.png
...
.. |order_submitted_img| image:: /img/system/workflows/checkout_with_consents/order_submitted.png
   :alt: The page of the order in the management console, once the order is submitted

.. |order_review_img| image:: /img/system/workflows/checkout_with_consents/order_review_step_checkout_with_consents.png
