...
In the Oro management console, workflows help users follow standard procedures that may be of a non-linear nature with alternating flow that depends on the available information, related items status, connectivity with integrated solutions, etc.
...
2. Click **Create Workflow** on the top right of the page.
   ...
   .. image:: /img/system/workflows/3_create_wf_button.png

3. On the **Create Workflow** page, specify the details of your workflow in the **General** section.

   .. image:: /img/system/workflows/4_create_wfpng.png
...
.. image:: /img/system/workflows/5_table_chart_example.png
...
.. image:: /img/system/workflows/designer_table.gif
...
.. image:: /img/system/workflows/auto_sort.gif
...
.. image:: /img/system/workflows/drag_transition.gif
...
.. image:: /img/system/workflows/6_manage_chart.png
...
1. Click **Add Step** in the top right corner of the chart.
   ...
   .. image:: /img/system/workflows/7_add_step.png
...
.. image:: /img/system/workflows/8_add_step_form.png

.. image:: /img/system/workflows/9_add_step_form_2.png
...
1. Click **Add Transition** on the top right of the chart.
   ...
   .. image:: /img/system/workflows/10_add_transition.png
...
.. csv-table::
   ...
   .. image:: /img/system/workflows/11_add_transition_form.png
...
.. image:: /img/system/workflows/12_specify_complaint.png

.. image:: /img/system/workflows/13_attribute_saved.png
...
.. tip:: After you have configured and saved your workflow, you can also configure sending email notification to the concerned parties when a transition is performed. For this, create an email notification rule as described in the :ref:`Notification Rules <system-notification-rules>` guide, and on the notification rule create page, specify the following:
         ...
         .. image:: /img/system/workflows/workflow_notification_rule.png
...
.. image:: /img/system/workflows/14_sample_flow_saved.png
...
3. If the workflow has configuration parameters, you can see the **Configuration** button on the top right of the workflow view page. Click this button.
   ...
   .. image:: /img/system/workflows/workflow_set_config_param.png

4. On the workflow configuration page, set the required values to the configuration parameters.

   .. image:: /img/system/workflows/workflow_set_config_param2.png
...
.. image:: /img/system/workflows/15_osf_ui_1.png

.. image:: /img/system/workflows/16_osf_ui_2.png
...
.. image:: /img/system/workflows/19_osf_ui.png
...
.. image:: /img/system/workflows/24_multiple_wfs.jpg
...
.. image:: /img/system/workflows/25_collapse_flow.jpg

.. image:: /img/system/workflows/26_collapse_flow_2.jpg
...
.. .. image:: /img/system/workflows/workflows_frontstore_backoffice.jpg
...
.. image:: /img/system/workflows/33_start_wf_manually.png
...
.. image:: /img/system/workflows/34_roles_wfs.png
...
.. image:: /img/system/workflows/35_translations.png
...
1. Click the |IcLanguage| **To Translations** icon next to the label that you want to translate. The translations list opens and is filtered to show only relevant translations.
   ...
   .. image:: /img/system/workflows/translations_relevantlist.png
...
3. Using the inline editor, specify the new translation for the label.
   ...
   .. image:: /img/system/workflows/translations_edit1.png

   .. image:: /img/system/workflows/translations_edit2.png
