...
2. Click **Create Template**.
   ...
   .. image:: /img/system/emails/templates/email_template_create.png
...
4. Define the email template. Click on the necessary variable to add it to the text box.
   ...
   .. image:: /img/system/emails/templates/email_template_ex.png
...
5. Click **Preview** to check your template.
   ...
   .. image:: /img/system/emails/templates/email_template_preview.png
...
.. note:: You can delete |IcDelete|, edit |IcEdit|, and clone |IcClone| email templates on the page of all templates.
          ...
          .. image:: /img/system/emails/templates/email_template_actions.png
...
.. image:: /img/system/emails/templates/email_template_language.png
