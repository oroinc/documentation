...
.. include:: /management_console/taxes/tax_rules/create.rst
   :start-after: begin
   :end-before: stop
...
.. include:: /management_console/taxes/tax_rules/viewlist.rst
   :start-after: begin
   :end-before: stop
...
#. Find the line with the necessary tax rule and click on it to open its details page.
   ...
   .. image:: /img/taxes/tax_rules_view.png
...
.. include:: /management_console/taxes/tax_rules/export_tax_rules.rst
   :start-after: start

Import Tax Rules
----------------

.. include:: /management_console/taxes/tax_rules/import_tax_rules.rst
   :start-after: start
