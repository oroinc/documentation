...
.. include:: /management_console/taxes/tax_jurisdictions/create.rst
   :start-after: begin
   :end-before: stop
...
.. include:: /management_console/taxes/tax_jurisdictions/viewlist.rst
   :start-after: begin
   :end-before: stop
...
#. Find the line with the necessary tax jurisdiction and click on it to open its details page.
   ...
   .. image:: /img/taxes/tax_jurisdiction_details.png
