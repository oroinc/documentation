...
Opportunities can be related to any customer type and customers introduced by various third-party extensions. They can also be :ref:`related directly to accounts <user-guide-opportunities-create--relate-to-account>`. This is the simplest application setup if you do not need to track multi-channel sales. You can always enable the additional complexity of multiple customer channels when the need arises.
...
#. A **Create Opportunity form** will open with an **Account** field pre-filled in with your selected Commerce customer.
   ...
   .. image:: /img/sales/opportunities/commerce_customer_create_opp.jpg
      :alt: Create an opportunity from a commerce customer

   .. image:: /img/sales/opportunities/commerce_opportunity_form.jpg
...
.. .. image:: /img/sales/opportunities/magento_customer_create_opportunity.jpg
.. .. image:: /img/sales/opportunities/magento_customer_create_opportunity_form.jpg
...
#. A **Create Opportunity form** will open with an **Account** field already filled in with your selected account.
   ...
   .. image:: /img/sales/opportunities/account_opportunity.jpg
      :alt: Create an opportunity from an account

   .. image:: /img/sales/opportunities/account_opp_form.jpg
...
#. Click **Convert Lead to Opportunity** on the lead page.
   ...
   .. image:: /img/sales/opportunities/convert_to_opportunity_button.png
      :alt: Convert lead to opportunity button

#. Provide details in the **Opportunity Information** section.

   .. image:: /img/sales/opportunities/convert_to_opportunity_2.0.jpg
...
#. Provide the details in the **New Contact Information** section. Since the lead has fulfilled its purpose and is no longer needed, a new contact will be created based on lead data entered in this form. It is possible to enter multiple phones, emails and addresses for an opportunity. You can choose which phone, email or address is to be primary. You can also delete the entered phone, email or address by clicking X on the right of the corresponding fields.
   ...
   .. image:: /img/sales/opportunities/contact_info_form_1.png
...
#. Provide the following information:
   ...
   .. image:: /img/sales/opportunities/create_opp_new.jpg
  ...
  * **Status** --- A stage in the process of a sale. **Open**, **Closed Won** and **Closed Lost** are system statuses that cannot be deleted.  Other statuses can be added and customized in the system configuration settings by an admin.
    ...
    .. image:: /img/sales/opportunities/status.jpg
...
.. Relate an Opportunity to an Account----------------------------------- hidden because Magento integration is deprecated

.. Opportunities can be related to any customer type, e-commerce or not, such as, Prestashop, OroCommerce and such like.
In the simplest setup, when you do not need the complexity of multi-channel sales, opportunities can be related directly to accounts. In this context, it is not recommended to use customers when selecting an account in the Opportunity Information form, since your customers will be represented by an account entity.

.. You can search for an account or create a new one.

.. .. image:: /img/sales/opportunities/plus_button_account.jpg

.. .. image:: /img/sales/opportunities/account_related_opportunity.jpg

.. Account view page displays opportunities related to a particular account in the **Action** section. :term:`Lifetime Sales Value` can be calculated based on the values of the opportunities related to an account.

.. .. image:: /img/sales/opportunities/account_view_page_opp.jpg
...
.. .. image:: /img/sales/opportunities/account_magento_customer.jpg
...
.. .. image:: /img/sales/opportunities/account_search_by_contact.jpg


.. Once saved, this opportunity will be related to an account via a customer.


.. .. image:: /img/sales/opportunities/magento_accountjpg.jpg
