...
.. image:: /img/marketing/marketing/mailchimp/mc_diagram.png
...
4. Add email information to the marketing list to send an email campaign via MailChimp.
   ...
   .. image:: /img/marketing/marketing/mailchimp/o_marketing_list_email.jpg
...
#. Click **Create List** on the top right, and then **Create List** in the popup.
   ...
   .. image:: /img/marketing/marketing/mailchimp/mc_create_list.png
...
#. Click **Connect**.
   ...
   .. image:: /img/marketing/marketing/mailchimp/o_select_mc_subscribers_list2.png
...
.. image:: /img/marketing/marketing/mailchimp/ml_connected_to_mc.png
...
.. image:: /img/marketing/marketing/mailchimp/mc_test_list2.jpg
...
#. Click **Create Campaign** on the top right.
   ...
   .. image:: /img/marketing/marketing/mailchimp/mc_create_campaign.png
      :alt: Create and send campaign on the MailChimp side

#. Click **Create an Email** in the popup.

   .. image:: /img/marketing/marketing/mailchimp/new_create_email_camp_mc.png
...
#. Select the type of the campaign to send:
   ...
   *  A/B Test
   ...
   .. image:: /img/marketing/marketing/mailchimp/campaign_types_mc.png
...
.. image:: /img/marketing/marketing/mailchimp/create_campaign_mc_steps.png
   :alt: Steps for the campaign in mailchimp

1. **To** --- Click **Add Recipients** to select the list segment for the email campaign. 

   .. image:: /img/marketing/marketing/mailchimp/mc_select_list_segment.png
...
2. **From** --- Click **Add From** to provide the sender name and email address.
   ...
   .. image:: /img/marketing/marketing/mailchimp/add_sender_details_to_campaign.png
...
3. **Subject** --- Click **Add Subject** to provide the subject line and preview text for the campaign.
    ...
    .. image:: /img/marketing/marketing/mailchimp/subject_line_campaign.png
...
create your own.
   ...
   .. image:: /img/marketing/marketing/mailchimp/design_campaign_template.png
...
6. Review campaign details and click **Send** on the top right.
   ...
   .. image:: /img/marketing/marketing/mailchimp/review_campaign_content.png
      :alt: Review campaign details before sending

7. Click **Send Now**

    .. image:: /img/marketing/marketing/mailchimp/prepare_for_launch.png
...
8. To look at your campaign statistics on the MailChimp side, click **Track Performance in Reports** on the same page. 
   ...
   .. image:: /img/marketing/marketing/mailchimp/campaign_sent.png
      :alt: A message informing that the email campaign is sent

   To do this manually, navigate to **Campaigns > View Report**. 
   
    .. image:: /img/marketing/marketing/mailchimp/view_report_campaign_mc.png
...
.. image:: /img/marketing/marketing/mailchimp/o_email_campaign_info.jpg
...
5. Select **Field Value.** In our case, it is 0.
   ...
   .. image:: /img/marketing/marketing/mailchimp/o_segment_opens_zero.jpg
