...
* Manage discounts in placed :ref:`orders <user-guide--sales--orders>` and view them in :ref:`shopping lists <user-guide--sales--shopping-lists>` in the management console.
