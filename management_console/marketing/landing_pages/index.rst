...
.. image:: /img/marketing/landing_pages/LandingPagesSample.png
...
#. Click **Create Landing Page**.
   ...
   .. image:: /img/marketing/landing_pages/LandingPagesCreate2.png
...
#. Fill in the landing page title (**Titles**) and translate it into the languages supported in your Oro configuration.
   ...
   To manage title translations, click |IcTranslate| next to the **Titles** box and follow the guidance :ref:`here <localization--localization>`).
...
#. Click on the Slug Prototypes box. The default slug prototype will be autogenerated. Edit the value to customize the default.
   ...
   To ensure that slug prototype translation is localization-friendly, manage slug prototype translations: click |IcTranslate| next to the **Slug Prototypes** box and follow the guidance :ref:`here <localization--localization>`).
...
#. Enter the landing page content in the WYSIWYG text editor or use the source code mode (**<>**) to enter the html code.
   ...
   .. note:: You can insert the *Contact Us widget* into the required page. For this, enter ``{{widget('contact_us_form')}}`` in the text editor and click **Save** in the top right corner. The form should then become visible in the storefront.
             ...
             .. image:: /img/marketing/landing_pages/ContactWidget.png
...
.. image:: /img/marketing/landing_pages/LandingPages.png
