...
1. Click **Add Address** in the right corner.
   ...
   .. image:: /user_doc/img/customers/customers/acc_add_address.png
...
2. Click **Save** once you have filled in all the fields.
   ...
   .. image:: /user_doc/img/customers/customers/acc_address_saved.png
...
.. image:: /user_doc/img/customers/customers/acc_address_correspondin_map.png
...
* **Edit an address** - To edit an address, click |IcEdit| on the right top of the address background, update the address details and click **Save**.
