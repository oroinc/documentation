...
#. Find the line with the necessary product tax code and click on it to open its details.
 ...
 * View Change History --- See the log of edits of this product tax code by clicking the **Change History** link to the top right of the page.
   ...
   .. image:: /user_doc/img/taxes/MEDICAL_IDENTIFICATION_TAGS_View_ProductTaxCodes_Taxes_ChangeHistory.png
 ...
 * |IcEdit| **Edit** or |IcDelete| **Delete** the selected product tax code.
   ...
   .. image:: /user_doc/img/taxes/link_tax_code_to_product.png
