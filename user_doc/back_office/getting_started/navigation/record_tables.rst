...
.. image:: /user_doc/img/getting_started/navigation/grids_grid.png
...
3. By clicking the grid link on the page of a record (see the screenshot below).
   ...
   .. image:: /user_doc/img/getting_started/navigation/grid_from_view.png
      :width: 40%
...
.. image:: /user_doc/img/getting_started/navigation/grids_pager.png
   :alt: Pager block
...
1. To show/hide filters, click |IcFilter|
   ...
   .. image:: /user_doc/img/getting_started/navigation/grids_filters.png
   ...
   .. image:: /user_doc/img/getting_started/navigation/grids_filters_applied-hidden.png
...
1. **Text fields that can take any value**
   ...
   .. image:: /user_doc/img/getting_started/navigation/grid_filters_define.png
      :width: 40%
...
3. **Dates and time**
   ...
   .. image:: /user_doc/img/getting_started/navigation/grids_filters_apply2-2.png
      :width: 40%
   ...
   .. image:: /user_doc/img/getting_started/navigation/grids_filters_apply2-3.png
      :width: 40%
