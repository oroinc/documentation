...
2. Hover over the more options menu at the end of the workflow row in the table of all workflows, and click |IcActivate| **Activate**.
   ...
   .. image:: /user_doc/img/sales/leads/unqualified_sales_lead_activate_from_grid.png
   ...
   .. image:: /user_doc/img/sales/leads/unqualified_sales_lead_wf.png
...
.. image:: /user_doc/img/sales/leads/unqualified_sales_lead_activated_lead_page.png
...
2. Hover over the more options menu at the end of the workflow row in the table of all workflows, and click |IcDeactivate| **Deactivate**.
   ...
   .. image:: /user_doc/img/sales/leads/unqualified_sales_lead_deactivate_from_grid.png
   ...
   .. image:: /user_doc/img/sales/leads/deactivate_unqualified_sales_lead_workflow_wf_page.png
...
.. image:: /user_doc/img/sales/leads/unqualified_sales_lead_disabled_lead_page.png
