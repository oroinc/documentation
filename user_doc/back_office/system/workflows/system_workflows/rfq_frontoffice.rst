...
.. image:: /user_doc/img/system/workflows/rfq/frontoffice/rfq_submission_flow_1.png
...
.. image:: /user_doc/img/system/workflows/rfq/frontoffice/rfq_submission_flow_2.png
...
.. image:: /user_doc/img/system/workflows/rfq/frontoffice/rfq_submission_flow_3.png
...
.. image:: /user_doc/img/system/workflows/rfq/frontoffice/rfq_submission_flow_4.png
...
.. note:: You can add and remove columns in the workflows list by clicking |IcConfig| on the far right of the list.
          ...
          .. image:: /user_doc/img/system/workflows/rfq/frontoffice/GridSettings.png
...
.. image:: /user_doc/img/system/workflows/rfq/frontoffice/RFQFrontOfficeTable.png
...
.. image:: /user_doc/img/system/workflows/rfq/frontoffice/RFQFrontofficeGrid_2.png
...
1. A customer user creates an RFQ in the storefront. Once the RFQ is sent, its customer status is marked as Submitted.
   ...
   .. image:: /user_doc/img/system/workflows/rfq/frontoffice/RFQButton.png
...
2. In the back-office, a sales representative sees the RFQ and requests more information. The RFQ is now in the Requires Attention customer status.
   ...
   .. image:: /user_doc/img/system/workflows/rfq/frontoffice/rfq_submission_flow_5.png

   .. image:: /user_doc/img/system/workflows/rfq/frontoffice/rfq_submission_flow_6.png
...
3. The customer user receives the request in the storefront, clicks Provide Information in the right corner of the page and replies to the message. The customer status is now Submitted.
   ...
   .. image:: /user_doc/img/system/workflows/rfq/frontoffice/RFQProvideInfo.png
   .. image:: /user_doc/img/system/workflows/rfq/frontoffice/RFQInformationProvided.png
...
.. finish_front_flow
 ...
 .. image:: /user_doc/img/system/workflows/rfq/frontoffice/RFQNotes.png
 .. image:: /user_doc/img/system/workflows/rfq/frontoffice/RFQCreateQuote.png
