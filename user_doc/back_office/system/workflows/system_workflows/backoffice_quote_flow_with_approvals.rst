...
.. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/backoffice_quote_with_approval.png
...
.. .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/backoffice_quote_with_approval_scheme.png
...
1. Jin creates a quote.
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_created.png
...
#. As a customer has a positive record and frequently buys headlamps in bulk, they have negotiated a personal discount of 1$ on every headlamp. The new price for the headlamp is 4$ (an MSRP, the best deal Jin could offer).
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_edited1.png
  ...
  .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_edited2.png

#. Jin clicks **Submit for Review**, enters a message that justifies the price update and sends the quote for review.

   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_sendforreview1.png
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_sendforreview2.png

   If email notifications were configured, Damara (as the authorized approver) might get an email about the review request.

   Sample email text:

   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_sendforreview_notification.png
...
#. Damara opens the quote submitted for review either via the link in the email or by looking it up in the quotes list using the filter by internal status (is any of "Submitted for Review").
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_review1.png
...
#. Damara clicks **Review** to move the quote to the *Under Review* status and communicate to Jin that his request is being processed.
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_review2.png

   The comment that Jin entered when submitting the quote for review is available in the quote's activities section:

   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_review4.png
   ...
   .. note:: Once the quote is under review, Jin can see the updated status. However, transitions to further steps are disabled until the approval is gained.
      ...
      .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_review3.png
...
#. As the modified price fits the current aggressive headlamp sale strategy, Damara approves the quote by clicking **Approve** and leaving a short message for Jim.
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_approve1.png

   This changes the quote status to *Approved*.

   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_approve2.png
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_approved_notification.png
...
#. Jin opens the approved quote either via the link in the email or by looking it up in the quotes list using the filter by internal status (is any of "Reviewed").
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_approve3.png
...
6. Jin clicks **Send To Customer** and reviews the email draft. Additional recipients may be added to the To, CC, or BCC fields. The email body may be adjusted to be more personalized.
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_sendtocustomer1.png
   ...
   * Capture that the customer has declined
   ...
   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_sendtocustomer2.png

   In the storefront, the quote becomes available to the customer user it was created for:

   .. image:: /user_doc/img/system/workflows/backoffice_quote_approval_flow/workflow_bqfa_quote_sendtocustomer3.png
