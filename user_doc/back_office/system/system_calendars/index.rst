...
.. note:: See a short demo on `how to create and manage calendars <https://www.oroinc.com/orocrm/media-library/create-and-manage-calendars#play=fVcOy3TmuQg>`_, or keep reading the step-by-step guidance below.
...
3. In the creation page, define the following fields:
   ...
   * **Scope** --- Define if this is a system or organization calendar (meaningful for enterprise edition only).
    ...
    .. image:: /user_doc/img/system/system_calendars/create_system_cal_new.png
