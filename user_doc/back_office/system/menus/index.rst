...
.. image:: /user_doc/img/system/menus/all_menus.png
...
.. image:: /user_doc/img/system/menus/ApplicationMenu.png

In a left position, application menu (navigation bar) may be collapsed into the icon bar:

.. image:: /user_doc/img/system/menus/ApplicationMenuVertical.png

or expanded for visible labels and sub-menu items:

.. image:: /user_doc/img/system/menus/ApplicationMenuVerticalExpanded.png
...
.. image:: /user_doc/img/system/menus/shortcut_full.png
...
.. image:: /user_doc/img/system/menus/menus_calendar_menu.png
...
.. image:: /user_doc/img/system/menus/menus_general.png
...
.. image:: /user_doc/img/system/menus/Menus.png
...
.. image:: /user_doc/img/system/menus/edit_menu.png
...
- If an arrow points to the place between items, that is where the moved item will be placed.
  ...
  .. image:: /user_doc/img/system/menus/menus_actions_d&dsame.png
     :width: 40%
...
- If and arrow appears in front of a menu item, then the moved item will become a child of the item that the arrow points to.
  ...
  .. image:: /user_doc/img/system/menus/menus_actions_d&dunder.png
     :width: 40%
...
3. In the right part of the page, specify the following information:
   ...
   - **Title**—A name for the menu item. This is how this menu item will be represented in the menu.
     ...
     .. image:: /user_doc/img/system/menus/menus_actions_create_translations.png
...
.. image:: /user_doc/img/system/menus/menus_createdivider.png
