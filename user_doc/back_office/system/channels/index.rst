...
In OroCRM, each channel record represents one source of customer-related data.

OroCRM Community Edition has two types of channels: Web (built for online stores) and Sales (built for business-to-business activities). For enterprise clients, additional types of channels can be added during system integration.

There is no limit to the number of channel records that may be defined for one OroCRM instance. Upon creation, you can choose what kind of customer-related information will be collected from each channel, as described below.
...
.. image:: /user_doc/img/system/channels/channels_entities.png
   :alt: Illustrate the Entities section with its details
...
.. image:: /user_doc/img/system/channels/channels_edit.png
