...
3. Select **System Configuration > General Setup > Language Settings** in the menu to the left.
   ...
   .. image:: /user_doc/img/system/user_management/org_configuration/general/language_configuration_organization.png

4. Clear the **Use System** check box and select the default language for the UI elements displayed in the back-office.
