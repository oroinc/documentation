...
.. image:: /user_doc/img/system/user_management/sales_bu_usa.png
...
.. image:: /user_doc/img/system/user_management/sales_bu_la.png
...
* Sales rep with **User** access level:
  ...
  .. image:: /user_doc/img/system/user_management/sales_role_rep.png

* Area sales manager with **Business Unit** access level:

  .. image:: /user_doc/img/system/user_management/sales_role_asm.png

* Regional sales manager with the **Division** access level.

  .. image:: /user_doc/img/system/user_management/sales_role_rsm.png

* Sales director with the **Organization** access level:
 
  .. image:: /user_doc/img/system/user_management/sales_role_dir.png
...
1. **Sales Director**
   ...
   * **Roles** --- System-wide sales director role
     ...
     .. image:: /user_doc/img/system/user_management/sales_user_sd_roles.png
 
   * **Organization** --- ACME Services

     .. image:: /user_doc/img/system/user_management/sales_user_sd_organization.png
...
.. image:: /user_doc/img/system/user_management/sales_acc_nina.png
...
.. image:: /user_doc/img/system/user_management/sales_acc_sam.png
...
.. image:: /user_doc/img/system/user_management/multi.png

John and Jane can only log into the organization they work with, while Jill can log into both.

.. comment .. image:: /user_doc/img/system/user_management/multi_login.png
...
.. image:: /user_doc/img/system/user_management/leads_structure.png

The diagrams below illustrate what information each of the team members can see:

.. image:: /user_doc/img/system/user_management/leads_visibility_aaron.png

*Aaron has access to both LA and NY BUs and all their records.*

.. image:: /user_doc/img/system/user_management/leads_visibility_alex.png

.. image:: /user_doc/img/system/user_management/leads_visibility_anna.png
