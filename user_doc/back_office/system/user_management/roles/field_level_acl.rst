...
.. image:: /user_doc/img/system/user_management/roles_permissions_fields_general_ex.png
...
4. In the **Other** section, enable the **Field Level ACL** check box.
   ...
   .. image:: /user_doc/img/system/user_management/access_field_level_acl_enable.png
...
.. image:: /user_doc/img/system/user_management/opportunity_greyed-status.png
...
4. In the **Other** section, enable the **Show Restricted** check box. 
   ...
   .. image:: /user_doc/img/system/user_management/access_field_level_acl_showrestricted.png
