...
2. Select **Commerce > Sales > Request for Quote** in the menu to the left.
   ...
   .. image:: /user_doc/img/system/config_commerce/sales/rfq_config_1.png
      :class: with-border
...
2. Select the corresponding option from the list.
  ...
  .. image:: /user_doc/img/system/config_commerce/sales/rfq_config_2.png
     :class: with-border
...
.. image:: /user_doc/img/system/config_system/RFQGlobal.png
