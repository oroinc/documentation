...
.. image:: /user_doc/img/system/config_system/budget_recalculated.png
...
.. image:: /user_doc/img/system/config_system/currency.png
...
|                        |                                                                                                                 |
|                        | .. image:: /user_doc/img/system/config_system/currency_code.png                                                 |
|                        |                                                                                                                 |
|                        | The order subtotal when the display format is set to *Currency Symbol*:                                         |
|                        |                                                                                                                 |
|                        | .. image:: /user_doc/img/system/config_system/currency_symbol.png                                               |
|                        |                                                                                                                 |
+------------------------+-----------------------------------------------------------------------------------------------------------------+
...
1. To change the base currency, click the **Base** option in the corresponding row. This will lead to reconversion of all multi-currency data to the new base currency, and all values will be re-converted according to the current rates.
   ...
   .. image:: /user_doc/img/system/config_system/currency_base1.png

   After:

   .. image:: /user_doc/img/system/config_system/currency_base3.png
...
.. image:: /user_doc/img/system/config_system/example_base_and_us_budget.png
...
.. image:: /user_doc/img/system/config_system/widgets_base_currency.png
...
2. To modify the currency exchange rate to and from the base currency, edit the **Rate To** and **Rate From** values in the corresponding row.
   ...
   .. image:: /user_doc/img/system/config_system/rate_recalculation.png
...
3. To add a currency to the allowed currencies list:
   ...
   a) Select the currency from the **Allowed Currencies** list and click **Add** next to it.
      ...
      .. image:: /user_doc/img/system/config_system/currency_add.png

      The currency is appended to the top of the list.

      .. image:: /user_doc/img/system/config_system/currency_add3.png
