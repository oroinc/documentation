...
2. Click on the website you would like to use as default (e.g. Australia).
   ...
   .. image:: /user_doc/img/system/websites/view_website_australia.png
...
.. image:: /user_doc/img/system/websites/default_australia_website.png
...
3. On the website details page, click |IcConfig| **Edit Frontend Menu**.
   ...
   .. image:: /user_doc/img/system/websites/front_menu.png
      :alt: The list of OroCommerce storefront menus

4. Click on the menu to start customizing it:

   .. image:: /user_doc/img/system/websites/edit_menu.png
   ...
   * Click on the menu item to edit its details.
     ...
     .. image:: /user_doc/img/system/websites/edit_menu_item.png
