...
3. Select **Commerce > Product > Promotions** in the menu to the left.
   ...
   .. image:: /user_doc/img/system/websites/web_configuration/NewArrivalsBlockWeb.png

4. In the **New Product Icons**, clear the **Use System** check box and select *Yes* in the **Show on Product View** list.
