...
4. In the **Product Image Watermark** section, the following options are available:
   ...
   * **Position** -- The watermark position on the image (e.g top left, top, top right, left, right, center, bottom left, bottom, and bottom right).
   ...
   .. image:: /user_doc/img/system/websites/web_configuration/ProductImagesPerWebsiteOptions.png
      :class: with-border

5. In the **Image Gallery Options** section, the following options are available:
   ...
   * **Enable Image Preview on Product Listing** --- When this option is enabled, clicking on the product image on the product listing page in the storefront will open a pop up image gallery, rather than the product page.
     ...
     .. image:: /user_doc/img/system/websites/web_configuration/ImagePreviewEnabledWebsite.png
        :class: with-border
     ...
     .. image:: /user_doc/img/system/websites/web_configuration/ImagePreviewDisabledWebsite.png
        :class: with-border

6. When **Popup Gallery on Product View** is enabled, image gallery in the storefront takes the following form:

   .. image:: /user_doc/img/system/websites/web_configuration/ImageGalleryWebsiteEnabled1.png
      :class: with-border

   By clicking on the image, the pop up gallery is displayed in the middle of the screen:

   .. image:: /user_doc/img/system/websites/web_configuration/ImageGalleryWebsiteEnabled2.png
      :class: with-border
...
5. When **Popup Gallery on Product View** is disabled, the image gallery takes the form of an inline view:
   ...
   .. note:: If the **Use System** check box is selected, system configuration is applied.
