...
* Contact Request
   ...
   .. image:: /user_doc/img/system/integrations/emb_form/cont_req.png
      :width: 50%
 
* Magento Contact Us Request
 
   .. image:: /user_doc/img/system/integrations/emb_form/cont_req_magento.png
      :width: 50%
...
3. Provide the following details: 
   ...
   * **Allowed Domains** --- Allowed cross origin domains where the form can be embedded. Supports wildcard, e.g., X.example.com.
      ...
      .. image:: /user_doc/img/system/integrations/emb_form/embedded_form_contact_us.png

4. Click **Save and Close**.

   .. image:: /user_doc/img/system/integrations/emb_form/emb_form_create_ex_02.png

Once saved, the form is displayed on the page of all embedded forms under **System > Integrations > Embedded Forms**.
  
.. image:: /user_doc/img/system/integrations/emb_form/emb_form_create_ex_01.png
...
.. image:: /user_doc/img/system/integrations/emb_form/emb_form_code.png
