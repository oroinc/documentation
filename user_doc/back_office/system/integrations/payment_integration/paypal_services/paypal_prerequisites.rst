...
#. Follow the on-screen guidance to prepare for integration: log into the Payflow Manager and create one or more API Transaction User(s).
   ...
   .. image:: /user_doc/img/system/integrations/paypal/paypal_sandbox_test_account.png
...
#. Log into the |https://manager.paypal.com/|:
   ...
   .. image:: /user_doc/img/system/integrations/paypal/paypal_manager_login.png
...
#. Navigate to the **Service Settings > Hosted Checkout Pages > Set Up**.
   ...
   .. image:: /user_doc/img/system/integrations/paypal/paypal_express_checkout_configuration1.png
...
.. image:: /user_doc/img/system/integrations/paypal/paypal_manager_add_user.png
