...
You can also engage RFQs in various activities, such as :ref:`adding a note <user-guide-add-note>`, :ref:`sending an email <user-guide-using-emails>` or :ref:`adding an event <doc-activities-events>` to a RFQ.

.. image:: /user_doc/img/sales/rfq/rfq_4.png
   :width: 100%
...
.. image:: /user_doc/img/sales/rfq/rfq_11.png
   :width: 100%
...
5. Add notes and assignees.
   ...
   .. image:: /user_doc/img/sales/rfq/rfq_9.png
      :width: 100%

6. Adjust target prices, add additional lines and products.

   .. image:: /user_doc/img/sales/rfq/rfq_10.png
      :width: 100%
...
.. image:: /user_doc/img/sales/rfq/rfq_12.png
   :class: with-border

.. image:: /user_doc/img/sales/rfq/rfq_13.png
   :class: with-border
...
.. image:: /user_doc/img/sales/rfq/rfq_14.png
   :class: with-border
...
3. Click **Submit**.
   ...
   .. image:: /user_doc/img/sales/rfq/rfq_15.png
      :class: with-border
...
.. image:: /user_doc/img/sales/rfq/rfq_16.png
   :class: with-border
...
.. image:: /user_doc/img/sales/rfq/rfq_17.png
   :class: with-border
