...
2. Click **Coupons Actions > Create Coupon** on the top right.
   ...
   .. image:: /user_doc/img/marketing/coupons/FindCoupon.png
...
2. Click **Coupons Actions > Generate Multiple Coupons** on the top right.
   ...
   .. image:: /user_doc/img/marketing/coupons/GenerateCoupons.png
...
.. image:: /user_doc/img/marketing/coupons/ActionsCoupons.png
...
7. Mass edit or mass delete coupons: Select the check boxes on the left of the corresponding rows. Click |IcMore| on the far right of the table header. Click |IcEdit| **Edit** to edit, or |IcDelete| **Delete** to delete the selected coupons.
   ...
   .. image:: /user_doc/img/marketing/coupons/MassActionsCoupons.png
...
.. include:: /user_doc/back_office/marketing/promotions/coupons/manage_coupons_in_orders.rst
...
.. include:: /user_doc/back_office/marketing/promotions/coupons/sample_coupon.rst
   :start-after: begin
   :end-before: finish
...
.. include:: /user_doc/back_office/marketing/promotions/coupons/export_coupons.rst
   :start-after: begin
   :end-before: finish
...
.. include:: /user_doc/back_office/marketing/promotions/coupons/import_coupons.rst
   :start-after: start
   :end-before: finish
