.. _user-guide--marketing--promotions--coupons--sample:
...
2. Click **Coupons Actions > Create Promotion** on the top right.
   ...
   .. image:: /user_doc/img/marketing/coupons/SampleCoupons1.png
      :alt: The steps you need to perform to get to the promotion creation page
...
2. Click **Coupons Actions > Generate Multiple Coupons**.
   ...
   .. image:: /user_doc/img/marketing/coupons/SampleCoupons3.png
...
3. In the pop up that opens, specify the details of the coupons, making sure that the **Coupon Quantity** is set to *100* and the coupons are linked to the newly created promotion (in our case, the Summer Sale promotion).
   ...
   .. image:: /user_doc/img/marketing/coupons/SampleCoupons4.png
      :alt: The popup dialog with the fields you need to fill to generate multiple coupons
...
5. The coupon for 50% off is now applied to the order.
   ...
   .. image:: /user_doc/img/marketing/coupons/SampleCoupons8.png
      :alt: The illustration of applying the coupon for 50% off to the order
...
6. In their storefront account, the customer will be able to see the discount applied to their order in the **Order History** menu.
   ...
   .. image:: /user_doc/img/marketing/coupons/SampleCoupons9.png
      :alt: The illustration of applying the coupon for 50% off to the order in the storefront
