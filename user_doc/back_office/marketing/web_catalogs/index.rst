...
.. image:: /user_doc/img/marketing/web_catalogs/WebCatalogs.png
   :alt: The page of all available web catalogs
...
* :ref:`Enable a Web Catalog  Globally <user-guide--marketing--web-catalog--enable-globally>` and :ref:`per Website <user-guide--marketing--web-catalog--enable-per-website>` in the back-office.

.. toctree::
   :hidden:

   create
   edit_content_tree/index
