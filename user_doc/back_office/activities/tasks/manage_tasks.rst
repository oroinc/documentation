...
2. Click the |IcEllipsisH| **More Options** menu at the end of the corresponding task row and select the appropriate action.
...
.. image:: /user_doc/img/activities/ManageTasksTaskPage.png
   :alt: The actions available on the task details page
...
3. Click the |IcEllipsisH| **More Options** menu at the end of the row with the task you would like to edit and select the appropriate action.
...
3. Click the |IcEllipsisH| **More Options** menu at the end of the task header to view, update, delete or close the existing task, add context, :ref:`start/stop the task progress <doc--workflows--task-flow>`.
4. Click **Add Comment** on the lower-right to add a comment to the task.

.. image:: /user_doc/img/activities/ManageTasksInRelatedRecord.png
   :alt: The actions available on the page of a certain record
