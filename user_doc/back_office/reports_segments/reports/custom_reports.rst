...
.. image:: /user_doc/img/reports/custom_reports_1.png
...
.. image:: /user_doc/img/reports/custom_reports_2.png
...
.. csv-table::
  ...
  .. image:: /user_doc/img/reports/custom_reports_3.png
  ...
  .. image:: /user_doc/img/reports/custom_reports_4.png
...
.. image:: /user_doc/img/reports/custom_reports_6.png
...
.. image:: /user_doc/img/reports/custom_reports_7.png
...
.. image:: /user_doc/img/reports/custom_reports_8.png
...
.. image:: /user_doc/img/reports/custom_reports_9.png
...
.. image:: /user_doc/img/reports/custom_reports_10.png
...
2. On the report page, click the **Export Grid** button in the upper-left corner, and then click **CSV** or **XLSX** to export the report to the file of the corresponding format.
   ...
   .. image:: /user_doc/img/reports/custom_reports_11.png
...
2. On the **All Reports** page, hover over the |IcEllipsisH| **More Options** menu, and then click the |IcEdit| **Edit** icon.
   ...
   .. image:: /user_doc/img/reports/custom_reports_12.png
...
2. On the **All Reports** page, click the required report.
   ...
   .. image:: /user_doc/img/reports/custom_reports_13.png
...
2. On the custom reports page, select the report to delete, hover over the |IcEllipsisH| **More Options** menu, and then click |IcDelete| **Delete**.
   ...
   .. image:: /user_doc/img/reports/custom_reports_14.png
...
.. image:: /user_doc/img/reports/custom_reports_15.png
...
2. Hover over the |IcMore| **More Options** menu at the end of the list header and click |IcDelete| to delete multiple reports at a time.
   ...
   .. image:: /user_doc/img/reports/custom_reports_16.png
