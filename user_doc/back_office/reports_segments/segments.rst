...
.. image:: /user_doc/img/reports/use_segments_in_filter.png
...
#. In the *General Details*:
   ...
   .. image:: /user_doc/img/reports/segment_general.png
...
#. In the *Designer > Columns* section, define the set of the fields of the entity records to be shown in the segment.
   ...
   .. image:: /user_doc/img/reports/list_columns.png
   ...
   In order to add a column to the grid:
      ...
      .. image:: /user_doc/img/reports/segments_column.png
...
.. image:: /user_doc/img/reports/segment_view.png
