...
#. In the *Filters* section, add the field condition to sort the data according to the purpose of the report:
   ...
   * Select one or several consents from the list.
   ...
   .. image:: /user_doc/img/system/consents/accepted_consents_report.png
...
.. image:: /user_doc/img/system/consents/consent_report_grid.png
...
.. image:: /user_doc/img/system/consents/accepted_consents_report_page.png
