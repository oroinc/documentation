...
3. In the **Google Hangouts** section, select the following check boxes:
   ...
   * **Enable for Phones** --- to make phone calls 
   ...
   .. image:: /user_doc/img/system/integrations/google/enable.png
...
2. Hover the mouse over a phone number or an email address on the page.
   ...
   .. image:: /user_doc/img/system/integrations/google/hover.png

3. Click the hangouts icon.
4. In the **Invite Contacts to a Google Hangout** form , click **Start a Hangout**.

   .. image:: /user_doc/img/system/integrations/google/invite.png
...
.. image:: /user_doc/img/system/integrations/google/enable_phone.png
...
.. image:: /user_doc/img/system/integrations/google/invite_more.png
...
.. image:: /user_doc/img/system/integrations/google/log_call_hangout.png
...
3. If the event has at least one guest invited, the **Start a Hangout** button is displayed.
   ...
   .. image:: /user_doc/img/system/integrations/google/view_event.png
      :width: 40%
