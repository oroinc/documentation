...
Add a Sample All Products Page
------------------------------
...
.. image:: /user_doc/img/products/all_products_page/SampleAllProducts1.png
...
2. For *Europe*, hover over the |IcMore| more actions menu, and click |IcConfig|.
   ...
   .. image:: /user_doc/img/products/all_products_page/SampleAllProducts2.png
...
4. In the **All Products** section, select the **Enable All Products Page** check box.
   ...
   .. image:: /user_doc/img/products/all_products_page/SampleAllProducts3.png
...
3. On the website page, click |IcConfig| **Edit Frontend Menu** to start editing the configuration.
   ...
   .. image:: /user_doc/img/products/all_products_page/SampleAllProducts4.png

4. Click once on the commerce_quick_access menu.

   .. image:: /user_doc/img/products/all_products_page/SampleAllProducts5.png

5. Click **Create Menu Item** on the top right.

   .. image:: /user_doc/img/products/all_products_page/SampleAllProducts6.png
...
6. Fill in the required fields:
   ...
   * Select an icon from the list
   ...
   .. image:: /user_doc/img/products/all_products_page/SampleAllProducts8.png
...
.. image:: /user_doc/img/products/all_products_page/SampleAllProducts7.png
