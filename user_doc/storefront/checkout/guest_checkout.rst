...
1. Add selected items to the shopping list.
   ...
   .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout1.png

2. Navigate to **Shopping List** on the top right of the page, and click **View Details**.

   .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout2.png

3. Click **Create Order** at the bottom of the shopping list page.

   .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout3.png

4. The following options are available on the page that opens:

   * Sign in

     .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout5.png

   * Create and Account

     .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout6.png

   * Forgot Your Password

     .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout7.png

   * Continue as a Guest

     .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout4.png
...
6. Fill in the billing and shipping information, as well as select the shipping method and provide payment details.
   ...
   .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout8.png
...
7. At the **Order Review** step, the following options are enabled by default:
   ...
   * Reenter password for confirmation.
   ...
   .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout9.png

8. Click **Submit Order**.

9. To complete registration, open your mailbox and check the registration confirmation email.

   .. image:: /user_doc/img/storefront/orders/SampleGuestCheckout10.png
