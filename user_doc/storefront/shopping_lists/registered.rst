...
.. image:: /user_doc/img/storefront/shopping_lists/ShoppingListName.png
...
.. image:: /user_doc/img/storefront/shopping_lists/CreateShoppingListItem.png
...
.. image:: /user_doc/img/storefront/shopping_lists/CreateShoppingListQuickOrder.png

**Flow 5**

1. Open :ref:`Matrix Ordering Form <frontstore-guide--orders-matrix>`.

.. image:: /user_doc/img/storefront/orders/HatProductPage.png

2. Enter the number of items for each category.

.. image:: /user_doc/img/storefront/orders/MatrixForm.png
...
.. image:: /user_doc/img/storefront/orders/MatrixFormShoppngList.png
...
.. image:: /user_doc/img/storefront/shopping_lists/DuplicateListFrontEndScreenShot.png
...
2. Click **Choose Action** on the top left next to the **Sort by** option.
   ...
   .. image:: /user_doc/img/storefront/navigation/MassActionProductListing.png
...
.. image:: /user_doc/img/storefront/shopping_lists/AddNoteShoppingList.png
...
While adding a product to a shopping list, click |IcChevronDown| to view a list of additional options available for the selected product.
  ...
  .. image:: /user_doc/img/storefront/shopping_lists/shopping_list_dropdown_1.png
...
.. image:: /user_doc/img/storefront/shopping_lists/SHEditName.png

2. Enter a new name and click **Save**.

.. image:: /user_doc/img/storefront/shopping_lists/SHEditName2.png
...
.. image:: /user_doc/img/storefront/shopping_lists/SHDelete.png
...
.. image:: /user_doc/img/storefront/shopping_lists/SHCreateOrder.png
