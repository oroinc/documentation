...
Feature: Check that not manageable entity is not editable from entity config in backoffice
  ...
  Scenario: Check entity management datagrid
    ...
    And filter Name as is equal to "NotManageableEntity"
    Then I should see following actions for NotManageableEntity in grid:
      | View |
    And I should not see following actions for NotManageableEntity in grid:
      | Edit  |
      | Delete|

  Scenario: Check entity view page and entity fields datagrid
    When I click view NotManageableEntity in grid
    ...
    Then I should not see following actions for id in grid:
      ...
      | Edit   |
      | Delete |
    And I should not see following actions for name in grid:
      | View   |
      | Edit   |
      | Delete |
