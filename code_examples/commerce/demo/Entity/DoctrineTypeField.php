 ...
 */
#[ORM\Entity(repositoryClass: 'Acme\Bundle\DemoBundle\Entity\Repository\DoctrineTypeFieldRepository')]
#[ORM\Table(name: 'acme_demo_doctrine_type_field')]
#[Config(
    ...
    defaultValues: [
        ...
        'grid' => ['default' => 'acme-demo-doctrine-type-field-grid-select'],
    ...
    ExtendEntityInterface
{
    ...
    #[ORM\Column(name: 'percent_field', type: 'float', nullable: true)]
