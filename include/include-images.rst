...
.. |IcDashboards| raw:: html

   <i class="far fa-chart-bar" aria-hidden="true"></i>

.. |IcCustomers| raw:: html

   <i class="fa fa-users" aria-hidden="true"></i>

.. |IcSales| raw:: html

   <i class="fas fa-dollar-sign" aria-hidden="true"></i>&ensp;

.. |IcProducts| raw:: html

   <i class="fa fa-briefcase" aria-hidden="true"></i>

.. |IcMarketing| raw:: html
...
.. |IcInventory| raw:: html

   <i class="fa fa-building" aria-hidden="true"></i>

.. |IcActivities| raw:: html
