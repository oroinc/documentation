...
Contact Reasons are used to help categorize the :ref:`contact requests <user-guide-activities-requests>` submitted by customers through any channel (either via the *Contact Us*, *Help* or any other form :ref:`embedded <admin-embedded-forms>` into your website, or by phone and email). You can create a list of contact reasons based on the most frequently asked questions or common issues to enable sales representatives to select the appropriate topic for contact requests.
...
2. The list of available reasons is displayed.
   ...
   .. image:: /admin_guide/img/contact_reasons/all_contact_reasons.png
...
.. image:: /admin_guide/img/contact_reasons/contact_request_page.png
...
.. image:: /admin_guide/img/contact_reasons/assign_contact_reason.png
