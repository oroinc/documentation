...
.. image:: /admin_guide/img/tags/tags_menu_1.png

.. note:: See a short demo on `how to create tags <https://oroinc.com/orocrm/media-library/tags-taxonomies>`_, or continue reading the guidance below.
...
1. Navigate to the main menu and click **System > Entities > Entity Management**.
   ...
   .. image:: /admin_guide/img/tags/entity_management_2.png

2. Click |IcEdit| to open the edit form for the required entity.

   .. image:: /admin_guide/img/tags/accounts_edit_3.png

3. In the **Other** section, select **Yes** in the **Enable Tags** field.

   .. image:: /admin_guide/img/tags/enable_tags_4.png
...
1. Click **Create Tag** to create a new tag.
   ...
   .. image:: /admin_guide/img/tags/create_tag_9.png
...
.. image:: /admin_guide/img/tags/create_tag_10.png
...
2. Within the list of an entity, select the required entity and click |IcPencil|.
   ...
   .. image:: /admin_guide/img/tags/entity_grid_inline_tag_11.png

2. Specify tags for the entity. You can enter multiple tags for one entity.

   .. image:: /admin_guide/img/tags/entity_grid_inline_tag_12.png

3. Click |IcCheck| to save the tags for the entity.

   .. image:: /admin_guide/img/tags/entity_grid_inline_tag_13.png
...
2. Click |IcPencil| in Tags.
   ...
   .. image:: /admin_guide/img/tags/entity_view_page_14.png

3. Specify tags for the entity. You can enter multiple tags for one entity.

   .. image:: /admin_guide/img/tags/entity_view_page_15.png

4. Click |IcCheck| to save the tags for the entity.

   .. image:: /admin_guide/img/tags/entity_view_page_16.png

   .. image:: /admin_guide/img/tags/entity_view_page_17.png
...
5. Configure grid settings for tags: |IcSettings|
   ...
   .. image:: /admin_guide/img/tags/tags_grid_manage_18.png

   .. image:: /admin_guide/img/tags/tags_grid_settings_19.png
...
.. image:: /admin_guide/img/tags/tag_link_20.png

.. image:: /admin_guide/img/tags/content_view_page_21.png
...
.. image:: /admin_guide/img/tags/report_create_gold_22.png

.. image:: /admin_guide/img/tags/report_created_gold_23.png
