...
8. In the **Storefront** section, you can specify the label to be displayed next to the coupon code in the **Order Summary** section of the checkout in the storefront (illustrated below). If left blank, the name of the promotion linked to the coupons will be used as the label.
