...
3. Provide the following information:
   ...
   .. csv-table::
     ...
     "**Source**","Provide the source of the issue. The possible options are:
     ...
     "**Priority**","Define priority of the task. The possible options are:
...
4. Click **Save** on the top right.
    ...
    .. image:: /user_guide/img/getting_started/activities/CreateCaseNew.png
