...
2. Click **Create Task** on the top right.
   ...
   .. image:: /user_guide/img/getting_started/activities/tasks/tasks_add_fromgrid.png

3. On the **Create Task** page, fill in the required information:
 
   .. image:: /user_guide/img/getting_started/activities/tasks/activities_tasks_actions_add0.png
   ...
   * **Reminders** — A notification about the upcoming task's due date. Click **+Add** to configure when and how Oro application remind the participants about the task:
...
2. Click **More Actions** on the top right of the page and then click **Assign Task**.
   ...
   .. image:: /user_guide/img/getting_started/activities/tasks/activities_tasks_actions_add_userpage1.png
...
3. In the **Assign Task To** dialog, specify the required data. Fill in the required information as described in the `Add a New Task Manually`_ section.
   ...
   .. image:: /user_guide/img/getting_started/activities/tasks/activities_tasks_actions_add_userpage2.png
...
1. On the page of a related record, click **More Actions > Add Task** on the top right of the page.
   ...
   .. image:: /user_guide/img/getting_started/activities/tasks/tasks_actions_add_related0.png

2. In the **Add Task** dialog, specify the required data, as described in the `Add a New Task Manually`_ section.

   .. image:: /user_guide/img/getting_started/activities/tasks/tasks_actions_add_related.png
