.. _doc-activities-events-actions-hangout-detailed:
...
3. On the calendar event view page, click the :guilabel:`Start Hangout` button in the upper-right corner of the page.
   ...
   .. image:: /user_guide/img/getting_started/activities/activities_events_actions_hangout2.png
...
2. On the **View Event** calendar card, click the :guilabel:`Start` button in the **Hangout** field.
   ...
   .. image:: /user_guide/img/getting_started/activities/activities_events_actions_hangout.png
