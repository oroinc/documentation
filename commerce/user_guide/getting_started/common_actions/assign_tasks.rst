...
The *Add Task* action will be available for records of entities with "Tasks" activity enabled in the entity settings.

1. Open the View page of a record the task is related to.

2. Click :guilabel:`Add Task` in the actions tab.
...
2. Click :guilabel:`Assign Task` in the actions tab.
