...
In order to fix some meeting, conference or another arrangement in your OroCommerce account, create a "*Calendar Event"*
...
2. Click :guilabel:`Add Event` in the actions tab.
...
2. Click :guilabel:`Assign Event` in the actions tab of the user.
