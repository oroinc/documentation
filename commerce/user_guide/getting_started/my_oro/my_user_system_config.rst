...
.. note:: This functionality is available only for OroCRM an OroCommerce Enterprise Edition.

.. For more information about the synchronization with Outlook, see the :ref:`Synchronization with Outlook <user-guide-synch-outlook>` guide.
