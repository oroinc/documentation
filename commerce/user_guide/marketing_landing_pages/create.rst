...
#. Click on the Slug Prototypes box. The default slug prototype will be autogenerated. Edit the value to customize the default.
   ...
   To ensure that slug prototype trnaslation is localization-friendly, manage slug prototype translations: click |IcTranslate| next to the **Slug Prototypes** box and follow the guidance `here <./getting-started/common-actions/manage-translation>`_).
