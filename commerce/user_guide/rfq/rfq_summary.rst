...
* **Refresh** --- Click |IcRefresh| to reload the information about the items. If another user recently updated the item details, these changes are reflected upon the refresh.
...
* Click |IcRequestMoreInfo| to communicate to the customer and :ref:`Request More Information <user-guide--sales--requests-for-quote--steps-and-transitions--more-info>` regarding the RFQ.
* Click |IcDecline| to :ref:`Decline <user-guide--sales--requests-for-quote--steps-and-transitions--decline>` the RFQ in view of irrelevance.
* Click |IcDelete| to :ref:`Delete <user-guide--sales--requests-for-quote--steps-and-transitions--delete>` the RFQ.
* Click |IcEdit| to :ref:`Edit <user-guide--sales--requests-for-quote--edit>` the RFQ upon request or necessity.
