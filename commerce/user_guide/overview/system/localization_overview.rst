...
OroCommerce supports localization and provides decent out-of-the-box translation coverage for the most used languages. With out-of-the box integration to CrowdIn service, OroCommerce has live access to the most recent updates from the Oro team and community. See `Translating OroCommerce into your Native Language <./../../community/translations>`_ for more information about translation process.
