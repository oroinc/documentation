...
3. In the form, complete the following fields:
   ...
   * **Promotion** --- Select the promotion that the coupon should relate to, or click |IcBars| to load the list of promotions to choose from. Please note that only promotions with the *Use Coupon* :ref:`option <user-guide--marketing--promotions--create>` set to *Yes* will be displayed on the list of available promotions.
   ...
   * **Valid Until** --- Provide the expiration date and time for the coupon.
