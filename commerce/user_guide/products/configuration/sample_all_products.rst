...
.. image:: /user_guide/img/system/menus/edit/SampleAllProducts1.png
...
2. For *Europe*, hover over the |IcMore| more actions menu, and click |IcConfig|.
   ...
   .. image:: /user_guide/img/system/menus/edit/SampleAllProducts2.png
...
4. In the **All Products** section, select the **Enable All Products Page** check box.
   ...
   .. image:: /user_guide/img/system/menus/edit/SampleAllProducts3.png
...
3. On the website page, click |IcConfig| **Edit Frontend Menu** to start editing the configuration.
   ...
   .. image:: /user_guide/img/system/menus/edit/SampleAllProducts4.png

4. Click once on the commerce_quick_access menu.

   .. image:: /user_guide/img/system/menus/edit/SampleAllProducts5.png

5. Click **Create Menu Item** on the top right.

   .. image:: /user_guide/img/system/menus/edit/SampleAllProducts6.png
...
6. Fill in the required fields:
   ...
   * Select an icon from the list
   ...
   .. image:: /user_guide/img/system/menus/edit/SampleAllProducts8.png
...
.. image:: /user_guide/img/system/menus/edit/SampleAllProducts7.png
