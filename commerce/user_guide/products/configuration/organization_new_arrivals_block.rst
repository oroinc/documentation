...
To set up the New Arrivals block per organization:
...
.. note:: Enabled **Use System** check box allows for system settings to be used. Clear this check box to manually change settings.
