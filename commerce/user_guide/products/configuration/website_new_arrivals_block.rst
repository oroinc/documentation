...
To set up the New Arrivals block per website:
...
.. note:: When the **Use System** check box is selected, the system settings are used. Clear this check box to enable manual change of settings.
