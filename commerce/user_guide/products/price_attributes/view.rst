...
.. Click |IcEdit| **Edit** on the top right of the price attribute view page to update the name of the price attribute, change the field name, and select alternative set of currencies this price attribute applies for. See :ref:`Edit Price Attribute <doc--price-attributes--actions--edit>` for more information.
