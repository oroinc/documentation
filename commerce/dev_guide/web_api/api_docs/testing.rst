...
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| cget                             | Sends GET request for a list of entities. See `get\_list action <./actions#get_list-action>`__.                                                                                                                                                                                                                           |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| get                              | Sends GET request for a single entity. See `get action <./actions#get-action>`__.                                                                                                                                                                                                                                         |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| post                             | Sends POST request for an entity resource. See `create action <./actions#create-action>`__. If the second parameter is a file name, the file should be located in the ``requests`` directory near to PHP file contains the test.                                                                                          |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| patch                            | Sends PATCH request for a single entity. See `update action <./actions#update-action>`__. If the second parameter is a file name, the file should be located in the ``requests`` directory near to PHP file contains the test.                                                                                            |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| delete                           | Sends DELETE request for a single entity. See `delete action <./actions#delete-action>`__.                                                                                                                                                                                                                                |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| cdelete                          | Sends DELETE request for a list of entities. See `delete\_list action <./actions#delete_list-action>`__.                                                                                                                                                                                                                  |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| getSubresource                   | Sends GET request for a sub-resource of a single entity. See `get\_subresource action <./actions#get_subresource-action>`__.                                                                                                                                                                                              |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| getRelationship                  | Sends GET request for a relationship of a single entity. See `get\_relationship action <./actions#get_relationship-action>`__.                                                                                                                                                                                            |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| postRelationship                 | Sends POST request for a relationship of a single entity. See `add\_relationship action <./actions#add_relationship-action>`__.                                                                                                                                                                                           |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| patchRelationship                | Sends PATCH request for a relationship of a single entity. See `update\_relationship action <./actions#update_relationship-action>`__.                                                                                                                                                                                    |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| deleteRelationship               | Sends DELETE request for a relationship of a single entity. See `delete\_relationship action <./actions#delete_relationship-action>`__.                                                                                                                                                                                   |
+----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
