...
-  **delete\_handler** *string* The id of a service that should be used to delete entity by the `delete <./actions.rst#delete-action>`__ and `delete\_list <./actions.rst#delete_list-action>`__ actions. By default the `oro\_soap.handler.delete <https://github.com/oroinc/platform/tree/master/src/Oro/Bundle/SoapBundle/Handler/DeleteHandler.php>`__ service is used.
-  **form\_type** *string* The form type that should be used for the entity in `create <./actions.rst#create-action>`__ and `update <./actions.rst#update-action>`__ actions. By default the ``form`` form type is used.
-  **form\_options** *array* The form options that should be used for the entity in `create <./actions.rst#create-action>`__ and `update <./actions.rst#update-action>`__ actions.
-  **form\_event\_subscriber** The form event subscriber(s) that should be used for the entity in `create <./actions.rst#create-action>`__ and `update <./actions.rst#update-action>`__ actions. Also this event subscriber is used for `update\_relationship <./actions.rst#update_relationship-action>`__, `add\_relationship <./actions.rst#add_relationship-action>`__ and `delete\_relationship <./actions.rst#delete_relationship-action>`__ actions, but only if the ``form_type`` option is not specified. For
...
-  **collapse** *boolean* Indicates whether the entity should be collapsed. It is applicable for associations only. It means that target entity should be returned as a value, instead of an array with values of entity fields. Usually this property is set by `get\_relation\_config <./actions.rst#get_relation_config-action>`__ processors to get identifier of the related entity.
-  **form\_type** *string* The form type that should be used for the field in `create <./actions.rst#create-action>`__ and `update <./actions.rst#update-action>`__ actions.
-  **form\_options** *array* The form options that should be used for the field in `create <./actions.rst#create-action>`__ and `update <./actions.rst#update-action>`__ actions.
...
+----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| nestedObject                                 | Used to configure nested objects. For details see `Configure nested object <./how_to.rst#configure-nested-object>`__.                                                                                                                                                                                                                                                                                        |
+----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| nestedAssociation                            | Used to configure nested associations. For details see `Configure nested association <./how_to.rst#configure-nested-association>`__.                                                                                                                                                                                                                                                                         |
+----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| association:relationType[:associationKind]   | Used to configure extended associations. For details see `Configure Extended Many-To-One Association <./how_to.rst#configure-extended-many-to-one-association>`__, `Configure Extended Many-To-Many Association <./how_to.rst#configure-extended-many-to-many-association>`__ and `Configure Extended Multiple Many-To-One Association <./how_to.rst#configure-extended-multiple-many-to-one-association>`__.|
+----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
