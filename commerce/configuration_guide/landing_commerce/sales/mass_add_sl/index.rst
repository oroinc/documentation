...
.. include:: /configuration_guide/landing_commerce/sales/mass_add_sl/global_mass_add_shopping_list.rst
   :start-after: begin_body
   :end-before: finish_body


Enable Mass Product Actions per Organization
--------------------------------------------

.. include:: /configuration_guide/landing_commerce/sales/mass_add_sl/organization_mass_add_shopping_list.rst
   :start-after: begin_body
   :end-before: finish_body


Enable Mass Product Actions per Website
---------------------------------------

.. include:: /configuration_guide/landing_commerce/sales/mass_add_sl/website_mass_add_shopping_list.rst
   :start-after: begin_body
   :end-before: finish_body
