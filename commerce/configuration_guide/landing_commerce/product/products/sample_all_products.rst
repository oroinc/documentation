...
2. For *Europe*, hover over the |IcMore| more actions menu, and click |IcConfig|.
   ...
   .. image:: /configuration_guide/img/menus/edit/SampleAllProducts2.png
...
4. In the **All Products** section, select the **Enable All Products Page** check box.
   ...
   .. image:: /configuration_guide/img/menus/edit/SampleAllProducts3.png
...
3. On the website page, click |IcConfig| **Edit Frontend Menu** to start editing the configuration.
   ...
   .. image:: /configuration_guide/img/menus/edit/SampleAllProducts4.png

4. Click once on the commerce_quick_access menu.

   .. image:: /configuration_guide/img/menus/edit/SampleAllProducts5.png

5. Click **Create Menu Item** on the top right.

   .. image:: /configuration_guide/img/menus/edit/SampleAllProducts6.png
...
6. Fill in the required fields:
   ...
   * Select an icon from the list
   ...
   .. image:: /configuration_guide/img/menus/edit/SampleAllProducts8.png
...
.. image:: /configuration_guide/img/menus/edit/SampleAllProducts7.png
