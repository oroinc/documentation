...
The **MIME types** settings can be configured globally and per organization.
...
.. include:: /configuration_guide/landing_system_configuration/general_setup_sysconfig/upload_settings_globally.rst
   :start-after: begin
   :end-before: finish
...
.. include:: /configuration_guide/landing_system_configuration/general_setup_sysconfig/upload_settings_organization.rst
   :start-after: begin
   :end-before: finish
