...
.. image:: /configuration_guide/img/outlook/outlook_integration_prerequisites.png


Check Hardware and System Requirements
--------------------------------------

.. include:: /configuration_guide/integrations/outlook/requirements.rst
...
1. Click **My User** below your username on the top right of the application.
   ...
   .. image:: /configuration_guide/img/outlook/my_user.png

2. Next to the **MS Outlook Add-in** option, click the link to download the file.

   .. image:: /configuration_guide/img/outlook/add_in_link.png
...
.. include:: /configuration_guide/integrations/outlook/connect.rst
...
.. include:: /configuration_guide/integrations/outlook/outlook_settings_oro.rst
...
.. include:: /configuration_guide/integrations/outlook/create_lead_opp_case.rst
...
.. include:: /configuration_guide/integrations/outlook/mapping.rst
...
.. include:: /configuration_guide/integrations/outlook/sync_flow.rst
