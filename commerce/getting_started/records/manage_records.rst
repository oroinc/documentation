...
The process of merging is illustrated in detail in the `Merging Accounts <https://oroinc.com/orocrm/media-library/merge-account-records-2>`__ video tutorial.
...
.. image:: /user_guide/img/getting_started/records/change_history.png
