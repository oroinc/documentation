...
3. Click **Log In**.
   ...
   .. image:: /user_guide/img/access_oro/login_ok.png
      :width: 40%
...
.. image:: /user_guide/img/access_oro/login_authcode.png
...
2. If the you not logged into any Google accounts, the usual Google log-in appears after clicking the link.
   ...
   * As soon as you have logged into you Google account, a request to use the account appears. Click **Allow**.
     ...
     .. image:: /user_guide/img/access_oro/google_connection.jpg
...
.. image:: /user_guide/img/access_oro/logout.png
