...
.. note:: See a short demo on `how to add comments <https://www.oroinc.com/orocrm/media-library/add-comments-orocrm>`_, or keep reading the guidance below.
...
.. image:: /user_guide/img/getting_started/activities/AddCommentToTask.png
