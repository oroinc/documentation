...
.. image:: /user_guide/img/marketing/mc_email_campaign/mc_diagram.png
...
4. Add email information to the marketing list to send an email campaign via MailChimp.
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/o_marketing_list_email.jpg
...
#. Click **Create List** on the top right, and then **Create List** in the pop up.
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/mc_create_list.png
...
#. Click **Connect**.
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/o_select_mc_subscribers_list2.png
...
.. image:: /user_guide/img/marketing/mc_email_campaign/ml_connected_to_mc.png
...
.. image:: /user_guide/img/marketing/mc_email_campaign/mc_test_list2.jpg
...
#. Click **Create Campaign** on the top right.
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/mc_create_campaign.png
      :alt: Create and send campaign on the MailChimp side

#. Click **Create an Email** in the pop up.

   .. image:: /user_guide/img/marketing/mc_email_campaign/new_create_email_camp_mc.png
...
#. Select the type of the campaign to send:
   ...
   *  A/B Test
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/campaign_types_mc.png
...
.. image:: /user_guide/img/marketing/mc_email_campaign/create_campaign_mc_steps.png
   :alt: Steps for the campaign in mailchimp

1. **To** --- Click **Add Recipients** to select the list segment for the email campaign. 

   .. image:: /user_guide/img/marketing/mc_email_campaign/mc_select_list_segment.png
   ...
   * **Personalize the** *To* **field > Mere Tag** --- Select this check box to personalize the emails in your campaign. This adds relevance to your emails and helps avoid spam filters. You will be asked to include **Merge Tags** to your email. Merge tags are personalization options. They include the names of the subscribers you want to send your emails to. In the provided field, specify merge tags for your recipients, i.e. \*\|FNAME\|\* or \*\|FNAME\|\* \*\|LNAME\|\*\ **.**
    ...
    .. image::/user_guide/img/marketing/mc_email_campaign/static_segment_mc.png
...
2. **From** --- Click **Add From** to provide the sender name and email address.
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/add_sender_details_to_campaign.png
...
3. **Subject** --- Click **Add Subject** to provide the subject line and preview text for the campaign.
    ...
    .. image:: /user_guide/img/marketing/mc_email_campaign/subject_line_campaign.png
...
create your own.
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/design_campaign_template.png
...
6. Review campaign details and click **Send** on the top right.
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/review_campaign_content.png
      :alt: Review campaign details before sending

7. Click **Send Now**

    .. image:: /user_guide/img/marketing/mc_email_campaign/prepare_for_launch.png
...
8. To look at your campaign statistics on the MailChimp side, click **Track Performance in Reports** on the same page. 
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/campaign_sent.png
      :alt: A message informing that the email campaign is sent

   To do this manually, navigate to **Campaigns > View Report**. 
   
    .. image:: /user_guide/img/marketing/mc_email_campaign/view_report_campaign_mc.png
...
.. image:: /user_guide/img/marketing/mc_email_campaign/o_email_campaign_info.jpg
...
5. Select **Field Value.** In our case, it is 0.
   ...
   .. image:: /user_guide/img/marketing/mc_email_campaign/o_segment_opens_zero.jpg
