...
.. image:: /admin_guide/img/workflows/rfq/frontoffice/rfq_submission_flow_1.png
...
.. image:: /admin_guide/img/workflows/rfq/frontoffice/rfq_submission_flow_2.png
...
.. image:: /admin_guide/img/workflows/rfq/frontoffice/rfq_submission_flow_3.png
...
.. image:: /admin_guide/img/workflows/rfq/frontoffice/rfq_submission_flow_4.png
...
.. note:: You can add and remove columns in the workflows list by clicking |IcConfig| on the far right of the list.
          ...
          .. image:: /admin_guide/img/workflows/rfq/frontoffice/GridSettings.png
...
.. image:: /admin_guide/img/workflows/rfq/frontoffice/RFQFrontOfficeTable.png
...
.. image:: /admin_guide/img/workflows/rfq/backoffice/RFQFrontofficeGrid_2.png
...
1. A customer user creates an RFQ in the storefront. Once the RFQ is sent, its customer status is marked as Submitted.
   ...
   .. image:: /admin_guide/img/workflows/rfq/frontoffice/RFQButton.png
...
2. In the management console, a sales representative sees the RFQ and requests more information. The RFQ is now in the Requires Attention customer status.
   ...
   .. image:: /admin_guide/img/workflows/rfq/frontoffice/rfq_submission_flow_5.png

   .. image:: /admin_guide/img/workflows/rfq/frontoffice/rfq_submission_flow_6.png
...
3. The customer user receives the request in the storefront, clicks Provide Information in the right corner of the page and replies to the message. The customer status is now Submitted.
   ...
   .. image:: /admin_guide/img/workflows/rfq/frontoffice/RFQProvideInfo.png
   .. image:: /admin_guide/img/workflows/rfq/frontoffice/RFQInformationProvided.png
...
4. The sales representative reads the reply in the Notes section of the RFQ page, marks the RFQ processed and creates a quote from the same page. The RFQ is now in the Processed customer status.
 ...
 .. image:: /admin_guide/img/workflows/rfq/frontoffice/RFQNotes.png
 .. image:: /admin_guide/img/workflows/rfq/frontoffice/RFQCreateQuote.png
