...
2. :ref:`Create a payment rule <sys--payment-rules>` and add your integration to it to display this method to the customers at the checkout.
 ...
 * :ref:`Prerequisites for Apruve Integration <user-guide--payment--prerequisites--apruve>` topic for the pre-integration steps.


**Related Topics**

* :ref:`Apruve integration <user-guide--payment--configuration--payment-method-integration--apruve>`
