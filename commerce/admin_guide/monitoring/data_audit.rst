...
2. Locate the required entity and open its edit page.
   ...
   .. image:: /admin_guide/img/data_audit/select_entity_for_data_audit.png
      :alt: Select an entity to edit

3. In the **Other** section, set the *Auditable* field to **Yes**.

   .. image:: /admin_guide/img/data_audit/auditable_field.png
...
.. image:: /admin_guide/img/data_audit/changed_history.png
...
.. image:: /admin_guide/img/data_audit/entity_fields_auditable.png
...
2. In the **Backoffice options** section, select **Yes** from the dropdown list for the *Auditable* field.
   ...
   .. image:: /admin_guide/img/data_audit/set_entity_field_to_auditable.png
   ...
   .. image:: /admin_guide/img/data_audit/change_history_for_product.png
...
5. Set the following conditions:
   ...
   * Interval between > 1.01.2018-31.12.2019
    ...
    .. image:: /admin_guide/img/data_audit/data_audit_report.png
...
7. Click **Save and Close**.
    ...
    .. image:: /admin_guide/img/data_audit/data_audit_report_generated.png
...
All changes made to auditable entities and fields are logged into the system and saved under **System > Data Audit**. You can filter the table by required parameters and save the filtered page for future reference.
 ...
 .. image:: /admin_guide/img/data_audit/data_audit_grid.png
