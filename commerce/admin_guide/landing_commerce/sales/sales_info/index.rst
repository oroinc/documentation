...
.. image:: /admin_guide/img/configuration/sales/contacts/FallBackOptions.png
...
.. include:: /admin_guide/landing_commerce/sales/sales_info/sales_info_global.rst
...
.. include:: /admin_guide/landing_commerce/sales/sales_info/sales_info_organization.rst
  :start-after: begin
  :end-before: finish
...
.. include:: /admin_guide/landing_commerce/sales/sales_info/sales_info_website.rst
  :start-after: begin
  :end-before: finish
...
.. include:: /admin_guide/landing_commerce/sales/sales_info/sales_info_user.rst
  :start-after: begin
  :end-before: finish
...
4. In **Guest Contact** text field, provide text for non-authenticated users, e.g.:
   ...
   *Please login to get your sales rep
   ...
   .. image:: /admin_guide/img/configuration/sales/contacts/UseCase1.png

5. Save the settings.

   This information should become available on the website for non-authenticated users.

   .. image:: /admin_guide/img/configuration/sales/contacts/FrontSalesRepInfoNonAuth.png
...
3. Provide contact details in **Enter Contact Info**, e.g.
   ...
   *John Doe, ACME 
   ...
   .. image:: /admin_guide/img/configuration/sales/contacts/UseCase2.png

4. Click **Save Settings**

The information should become available on the website.

.. image:: /admin_guide/img/configuration/sales/contacts/FrontSalesRepInfoLoggedIn.png
