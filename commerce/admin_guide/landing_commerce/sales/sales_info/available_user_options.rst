...
* **Don't Display Contact Info** -- allow setting the option of no sales rep information to be displayed.
  ...
  .. image:: /admin_guide/img/configuration/sales/contacts/DontDisplayInfoAdmin.png

  Then:

  .. image:: /admin_guide/img/configuration/sales/contacts/DontDisplayInfoSalesRep.png
...
* **Use User Profile Data** -- allow setting the option of user profile details to be displayed.
  ...
  .. image:: /admin_guide/img/configuration/sales/contacts/UseUserProfileDataAdmin.png

  Then:

  .. image:: /admin_guide/img/configuration/sales/contacts/UseUserProfileDataSalesRep.png
...
* **Enter Manually** -- allow to set the option of manually entered text in the *Enter Contact Info* field.
  ...
  .. image:: /admin_guide/img/configuration/sales/contacts/EnterManuallyAdmin.png

  Then:

  .. image:: /admin_guide/img/configuration/sales/contacts/EnterManuallySalesRep.png
  ...
  .. note:: You can choose to use multiple options by holding Ctrl when selecting the option. When all options are selected in **Available User Options**, the user will see them all in their configuration settings as well.
    ...
    .. image:: /admin_guide/img/configuration/sales/contacts/SelectMultipleOptions.png

    Then:

    .. image:: /admin_guide/img/configuration/sales/contacts/AllOptionsSalesRep.png
