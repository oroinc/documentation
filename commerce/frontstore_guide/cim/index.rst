...
.. image:: /frontstore_guide/img/cim/manage_payment_profiles.png
...
2. In the **New Payment Profile** form, provide the following details:
   ...
   .. image:: /frontstore_guide/img/cim/add_new_credit_card.png
...
.. image:: /frontstore_guide/img/cim/new_credit_card_at_checkout.png
...
1. Scroll down to the bottom of the Profile list and click **New Card**.
   ...
   .. image:: /frontstore_guide/img/cim/add_new_card_at_checkout.png
      :alt: New credit card added as a payment method at checkout

2. Provide the details of the new card in the form:

   .. image:: /frontstore_guide/img/cim/new_card_at_checkout_form.png
...
3. To save the details of the card for the future use, select the **Save Payment Details** check box.
   ...
   .. image:: /frontstore_guide/img/cim/card_form_fillied_in_checkout.png
   ...
   .. image:: /frontstore_guide/img/cim/new_card_from_checkou_saved_to_account.png
...
* To edit a credit card, click |IcPencil| **Edit** at the end of the row of the selected profile.
  ...
  .. image:: /frontstore_guide/img/cim/update_payment_profile.png
  ...
  .. image:: /frontstore_guide/img/cim/update_credit_card_info.png
...
* To delete credit card, click |IcDelete| **Delete** at the end of the row of the selected profile. Click **Yes** in the confirmation dialog.
  ...
  .. image:: /frontstore_guide/img/cim/delete_credit_card.png
...
2. In the **New Payment Profile** form, provide the following details:
    ...
    .. image:: /frontstore_guide/img/cim/bank_account_new.png
...
.. image:: /frontstore_guide/img/cim/new_bank_account_at_checkout.png
...
1. Scroll down to the bottom of the Profile list and click **New Bank Account**.
   ...
   .. image:: /frontstore_guide/img/cim/add_new_bank_acc_at_checkout.png
...
3. To save the details of the bank account for the future use, select the **Save Payment Details** check box.
    ...
    .. image:: /frontstore_guide/img/cim/new_acc_at_checkout_form.png
...
* To edit a bank account, click |IcPencil| **Edit** at the end of the row of the selected profile.
  ...
  .. image:: /frontstore_guide/img/cim/update_bank_acc_profile.png
  ...
  .. image:: /frontstore_guide/img/cim/update_bank_acc_info.png
...
* To delete a bank account, click |IcDelete| **Delete** at the end of the row of the selected profile. Click **Yes** in the confirmation dialog.
  ...
  .. image:: /frontstore_guide/img/cim/delete_bank_acc.png
...
.. image:: /frontstore_guide/img/cim/credit_card_details_authorize_side.png
