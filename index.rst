    ...
    <div class="guideline">
        <div class="guideline__item">
            ...
            <ul class="guideline__list simple">
                ...
                <li><a class="reference internal" href="admin-guide/monitoring/security-data-audit#user-guide-data-audit">Data Audit</a></li>
                </li>
            </ul>
        </div>
        <div class="guideline__item">
        ...
        <div class="guideline__item">
            ...
            <ul class="guideline__list simple">
                ...
                <li><a class="reference internal" href="admin-guide/app-look-feel/menus-config">Menus Configuration</a></li>
    ...
    <div class="guideline">
        <div class="guideline__item">
            ...
            <ul class="guideline__list">
                <li><a class="reference internal" href="dev-guide/getting-started-book/configuration/">Configuration</a>, <a class="reference internal" href="dev-guide/getting_started_book/localization">localization</a>, and <a class="reference internal" href="dev-guide/getting_started_book/security">security</a>, and <a class="reference internal" href="dev-guide/customization">customization</a></li>
        ...
        <div class="guideline__item">
            ...
            <ul class="guideline__list">
                ...
                <li><a class="reference internal" href="dev-guide/cookbook/how-to-install-extension-from-command-line">Extension installation</a></li>
...
.. raw:: html
    ...
    <div class="guideline">
        <div class="guideline__item">
            <a class="reference internal" href="user-guide"><h3 style="text-align:center"><i class="guideline__icon fa fa-user fa-2x" style="color:#FFC221"></i><br />User Guide</h3></a>
            <ul class="guideline__list simple">
                <li><a class="reference internal" href="user-guide/access-oro/">Access Oro</a></li>
                <li><a class="reference internal" href="user-guide/navigation/">Navigation and Search</a></li>
                <li><a class="reference internal" href="user-guide/my-oro/">My Oro</a></li>
        ...
        <div class="guideline__item">
            <a class="reference internal" href="admin-guide/"><h3 style="text-align:center"><i class="guideline__icon fa fa-cog fa-2x" style="color:#FFC221"></i><br />Administrator Guide</h3></a>
            <ul class="guideline__list simple">
...
.. raw:: html
    ...
    <div class="guideline">
        <div class="guideline__item">
            ...
            <ul class="guideline__list">
                <li><a class="reference internal" href="book/configuration">configuration</a>, <a
                        class="reference internal" href="localization">localization</a>, and <a class="reference internal"
        ...
        <div class="guideline__item">
            ...
            <ul class="guideline__list">
                <li><a class="reference internal" href="cookbook/entities">Entity customization</a></li>
        ...
        <div class="guideline__item">
            <a class="reference internal" href="bundles"><h3 style="text-align:center"><i
    ...
    <div style="float: none;margin: 0 auto;width: 100%;height:100%">
        <a class="reference internal" href="reference"><h3><i class="guideline__icon fa fa-bookmark fa-2x"
