...
More information on how RFM is configured in your Oro application can be found in the :ref:`RFM analysis topic <user-guide-rfm-user>`.
...
The :ref:`Abandoned Cart Campaigns guide <user-guide-acc>` will take you through the process of sending such campaigns step by step.
