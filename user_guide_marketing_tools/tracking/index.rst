...
.. note::  Tracking of Magento stores is pre-implemented and available with the extension that you can download at https://marketplace.magento.com/oro-oro-tracking.html
...
3. In the **General** section, provide the following information:
   ...
   * **Channel** --- Select the channel to connect the tracking record to. If this is done, you will be able to bind events registered by the tracking engine and other Oro application data like orders, shopping carts, customer profiles, etc. This connection can be further utilized in reports and segments.
   ...
   .. image:: /user_guide/img/marketing/marketing/tracking_create.png
...
5. The javascript code is generated once you save the tracking website.
   ...
   .. image:: /user_guide/img/marketing/marketing/javascript_code.png
...
.. image:: /user_guide/img/marketing/marketing/javascript_code_detail.png
...
.. image:: /user_guide/img/marketing/marketing/cart_item_added.png
...
.. image:: /user_guide/img/marketing/marketing/phone_button_clicked.png
...
.. image:: /user_guide/img/marketing/marketing/banner_clicked.png
...
.. image:: /user_guide/img/marketing/marketing/tracking_website_actions.png
...
.. image:: /user_guide/img/marketing/marketing/tracking_website_action.png
...
.. image:: /user_guide/img/marketing/marketing/tracking_website_share.png
...
.. important:: To make sure that synchronization between your website and the application is successful, you may need to enable dynamic website tracking. For this, navigate to **System > Configuration > General Setup > Tracking**, and select the **Enable Dynamic Tracking** check box.
   ...
   .. image:: /user_guide/img/marketing/marketing/enable_dynamic_tracking_new.png
