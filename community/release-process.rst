:title: Understanding OroCommerce and OroCRM 4.1 Release Process

.. meta::
   :description: Insights into the Oro 4.1 application release process, versioning strategy, and upgrade recommendations
...
+--------------------------------+-------------------+-------------------+-------------------+
| 4.2 Alpha1                     | March 2020        | March 2020        | March 2020        |
+--------------------------------+-------------------+-------------------+-------------------+
| 4.2 Alpha2                     | May 2020          | May 2020          | May 2020          |
+--------------------------------+-------------------+-------------------+-------------------+
| 4.2 Alpha3                     | July 2020         | July 2020         | July 2020         |
+--------------------------------+-------------------+-------------------+-------------------+
| 4.2 Beta                       | September 2020    | September 2020    | September 2020    |
+--------------------------------+-------------------+-------------------+-------------------+
| 4.2 RC                         | November 2020     | November 2020     | November 2020     |
+--------------------------------+-------------------+-------------------+-------------------+
...
If you are planning to start a new project this year which is scheduled to go live after January 2021, we recommend to start the development on the most recent release in 4.2.x series. You might need to continually upgrade to the next available 4.2 Alpha, Beta and RC  versions and ultimately upgrade to 4.2 LTS version prior to going live with the project.
...
- **Stable** – |4.1 branch| points to the latest LTS version. Use this branch for testing and deployment. To benefit from the latest features, fixes, and security updates, upgrade to the next patch release tag or LTS release tag as soon as they are available.
- **Development** – |4.2 branch| points to the latest available commit and is updated daily. This branch should be used **only by the developers and contributors** who actively follow the project progress on GitHub. This branch is not considered stable and it is not recommended for production use.
...
+-------------------------------+-------------------+--------------------------------+
| 4.2 Alpha1                    | March 2020        | N/A                            |
+-------------------------------+-------------------+--------------------------------+
| 4.2 Alpha1                    | May 2020          | N/A                            |
+-------------------------------+-------------------+--------------------------------+
| 4.2 Alpha3                    | July 2020         | N/A                            |
+-------------------------------+-------------------+--------------------------------+
| 4.2 Beta                      | September 2020    | N/A                            |
+-------------------------------+-------------------+--------------------------------+
| 4.2 RC                        | November 2020     | N/A                            |
+-------------------------------+-------------------+--------------------------------+
