...
Add Custom Entity Config Validation
-----------------------------------

For details on how to add validation, see the :ref:`Entity Configuration Validation <book-entities-entity-configuration-validation>` topic.
