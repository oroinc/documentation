...
For the default website, the robots txt file is also dumped to the root of the public directory if the dump command has permissions to write to the `public/robots.txt` file.
