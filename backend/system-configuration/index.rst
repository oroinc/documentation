...
:title: System Configuration Management in OroCommerce, OroCRM, OroPlatform 4.1
...
``Oro\Bundle\ConfigBundle\DependencyInjection\SettingsBuilder`` in the well-known
``Configuration`` class:
