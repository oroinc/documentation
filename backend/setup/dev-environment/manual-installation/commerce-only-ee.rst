.. _installation--orocommerce-only-ee--readme:
...
.. csv-table::
   ...
   "**Search engine**","Elasticsearch v.6.*"
...
.. _installation--orocommerce-only-ee--part-3:
...
.. code:: bash
   ...
   composer create-project oro/commerce-enterprise-application oroapp --repository=https://satis.oroinc.com
   cd oroapp
