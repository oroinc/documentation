...
3. Install PHP 8.0, Composer, Node.js 14 and Docker Compose:

   .. code-block:: none

      brew install php@8.0 composer node docker-compose
      echo 'export PATH="/usr/local/opt/php@8.0/bin:$PATH" \nexport PATH="/usr/local/opt/php@8.0/sbin:$PATH" \nexport PATH="/usr/local/opt/node@12/bin:$PATH"' >> ~/.bash_profile
...
5. Configure PHP:
   ...
   .. code-block:: none
      ...
      echo "memory_limit = 2048M \nmax_input_time = 600 \nmax_execution_time = 600 \nrealpath_cache_size=4096K \nrealpath_cache_ttl=600 \nopcache.enable=1 \nopcache.enable_cli=0 \nopcache.memory_consumption=512 \nopcache.interned_strings_buffer=32 \nopcache.max_accelerated_files=32531 \nopcache.save_comments=1" >> /usr/local/etc/php/8.0/php.ini
