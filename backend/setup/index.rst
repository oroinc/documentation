               ...
               <li>
                ...
                <li>
                    ...
                    <div style="text-align: center">
                        ...
                        <ul class="guideline__list">
                                      <li><a class="reference internal" href="#launch">Plan</a></li>
                                      <li><a class="reference internal" href="#pre-launch">Pre-Launch</a></li>
                                      <li><a class="reference internal" href="#id1">Launch</a></li>
                                      <li><a class="reference internal" href="#go-live-checklist">Checklist</a></li>
                        </ul>
                </li>
