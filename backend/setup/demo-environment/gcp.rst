...
.. warning:: OroCommerce VM for version 5.0 is no longer available on Google Marketplace. You can now deploy an image of the latest LTS version, as illustrated below.
