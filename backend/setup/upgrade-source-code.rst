...
Once the source code is upgraded, the next step is to upgrade the Oro application to v6.0. For full instructions, refer to the :ref:`Upgrading the Application to the Next Version <upgrade-application>` documentation.
