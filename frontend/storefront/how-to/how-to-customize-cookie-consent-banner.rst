...
The text and policy page link are set in the back-office, under **System > Configuration > Commerce > Customer > Customer Users > Cookies Banner**. No code is needed. See :ref:`Cookie Consent Banner <frontstore-guide--cookie-banner>` for details.
