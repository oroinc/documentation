...
# directories to ignore when looking for source files. , 'backend', 'frontend', 'community', 'developer', 'user'
exclude_patterns = ['_build', 'completeReference/overview', 'sphinx', 'docker', '_themes', 'bundles']
...
developer_titles = ['Backend Developer Guide', 'Frontend Developer Guide', 'Web Services API Guide', 'Community Guide']
