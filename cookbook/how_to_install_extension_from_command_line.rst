...
Start with upgrading Composer to the latest version. This may be needed in case if the extension to be
...
There are two commands that help you get an overview about the extension.
