...
.. tip::
    ...
    You can use the optional group attributes to create visual groups in the UI that can help the
    user find your entity.
...
Once you have configured the ACLs you can protect all parts of your application:
