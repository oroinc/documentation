...
It is implemented by the :ref:`OroOAuth2ServerBundle <bundle-docs-platform-oauth2-server-bundle>` that supports |OAuth 2.0 Authorization Code Grant|, |OAuth 2.0 Client Credentials Grant| and |OAuth 2.0 Password Grant|.
